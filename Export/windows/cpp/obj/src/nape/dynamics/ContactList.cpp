...
::nape::dynamics::Contact ContactList_obj::at( int index){
	...
	struct _Function_1_1{
		inline static bool Block( hx::ObjectPtr< ::nape::dynamics::ContactList_obj > __this,int &index){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/dynamics/ContactList.hx",368,0xd6cc37f4)
			{
				HX_STACK_LINE(368)
...
bool ContactList_obj::push( ::nape::dynamics::Contact obj){
	...
	if ((this->zpp_inner->immutable)){
		HX_STACK_LINE(418)
		HX_STACK_DO_THROW(HX_CSTRING("Error: ContactList is immutable"));
	}
	HX_STACK_LINE(420)
...
::nape::dynamics::Contact ContactList_obj::pop( ){
	...
	struct _Function_1_1{
		inline static bool Block( hx::ObjectPtr< ::nape::dynamics::ContactList_obj > __this){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/dynamics/ContactList.hx",484,0xd6cc37f4)
			{
				HX_STACK_LINE(484)
				int _g;		HX_STACK_VAR(_g,"_g");
				HX_STACK_LINE(484)
...
::nape::dynamics::Contact ContactList_obj::shift( ){
	...
	struct _Function_1_1{
		inline static bool Block( hx::ObjectPtr< ::nape::dynamics::ContactList_obj > __this){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/dynamics/ContactList.hx",525,0xd6cc37f4)
			{
				HX_STACK_LINE(525)
				int _g;		HX_STACK_VAR(_g,"_g");
				HX_STACK_LINE(525)
	...
	HX_STACK_ARG(deep,"deep")
{
		...
		HX_STACK_LINE(664)
		{
			...
			while((true)){
				...
				if ((deep)){
					HX_STACK_LINE(666)
					HX_STACK_DO_THROW(HX_CSTRING("Error: Contact is not a copyable type"));
					HX_STACK_LINE(668)
					_g1 = null();
				}
				else{
