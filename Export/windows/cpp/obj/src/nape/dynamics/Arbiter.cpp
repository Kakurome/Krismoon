	...
	HX_STACK_ARG(freshOnly,"freshOnly")
{
		...
		struct _Function_1_1{
			inline static bool Block( hx::ObjectPtr< ::nape::dynamics::Arbiter_obj > __this,::nape::phys::Body &body){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/dynamics/Arbiter.hx",355,0x42fd8209)
				{
					HX_STACK_LINE(355)
...
::String Arbiter_obj::toString( ){
	...
	if ((this->zpp_inner->cleared)){
		...
		struct _Function_2_1{
			inline static ::nape::shape::Shape Block( hx::ObjectPtr< ::nape::dynamics::Arbiter_obj > __this){
		...
		HX_STACK_LINE(379)
		::String _g = (_Function_2_1::Block(this))->toString();		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(379)
		...
		HX_STACK_LINE(379)
		::String _g3 = (_Function_2_2::Block(this))->toString();		HX_STACK_VAR(_g3,"_g3");
		HX_STACK_LINE(379)
															...
															inline static ::nape::callbacks::PreFlag Block( int &_g8,int &x1){
																HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/dynamics/Arbiter.hx",379,0x42fd8209)
																{
																	...
																	if (  ( _switch_2==::zpp_nape::util::ZPP_Flags_obj::id_ImmState_ACCEPT)){
																		...
																		HX_STACK_LINE(379)
																		return (  (((x1 == ((int(::zpp_nape::util::ZPP_Flags_obj::id_ImmState_IGNORE) | int(::zpp_nape::util::ZPP_Flags_obj::id_ImmState_ALWAYS)))))) ? ::nape::callbacks::PreFlag(_Function_8_1::Block()) : ::nape::callbacks::PreFlag(_Function_8_2::Block()) );
																	}
;
;
																}
														...
														HX_STACK_LINE(379)
														return _Function_6_1::Block(_g8,x1);
													}
													return null();
												}
											};
											HX_STACK_LINE(379)
											return (  (((x == ((int(::zpp_nape::util::ZPP_Flags_obj::id_ImmState_ACCEPT) | int(::zpp_nape::util::ZPP_Flags_obj::id_ImmState_ALWAYS)))))) ? ::nape::callbacks::PreFlag(_Function_5_1::Block()) : ::nape::callbacks::PreFlag(_Function_5_2::Block(_g8)) );
										}
										return null();
									}
								};
								HX_STACK_LINE(379)
								return _Function_4_1::Block(_g8);
							}
							return null();
						}
					};
		...
		HX_STACK_LINE(379)
		::String _g12 = (_Function_2_3::Block(this))->toString();		HX_STACK_VAR(_g12,"_g12");
		HX_STACK_LINE(379)
		return (_g7 + _g12);
	}
	HX_STACK_LINE(378)
