...
{
HX_STACK_FRAME("nape.dynamics.ArbiterType","new",0x498d4181,"nape.dynamics.ArbiterType.new","nape/dynamics/ArbiterType.hx",183,0xeb73a8ef)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(183)
	if ((!(::zpp_nape::util::ZPP_Flags_obj::internal))){
		HX_STACK_LINE(183)
		HX_STACK_DO_THROW(HX_CSTRING("Error: Cannot instantiate ArbiterType derp!"));
	}
}
;
	return null();
