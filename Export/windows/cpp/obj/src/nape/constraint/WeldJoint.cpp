...
Float phase = __o_phase.Default(0.0);
{
	...
	HX_STACK_LINE(378)
	{
		HX_STACK_LINE(378)
		{
			...
			if (((phase != phase))){
				HX_STACK_LINE(378)
				HX_STACK_DO_THROW(HX_CSTRING("Error: WeldJoint::phase cannot be NaN"));
			}
			HX_STACK_LINE(378)
...
::nape::geom::Vec3 WeldJoint_obj::bodyImpulse( ::nape::phys::Body body){
	HX_STACK_FRAME("nape.constraint.WeldJoint","bodyImpulse",0xb2ac857e,"nape.constraint.WeldJoint.bodyImpulse","nape/constraint/WeldJoint.hx",395,0x63bebec5)
	HX_STACK_THIS(this)
