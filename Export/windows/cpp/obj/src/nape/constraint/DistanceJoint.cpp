	...
	HX_STACK_LINE(421)
	{
		HX_STACK_LINE(421)
		{
			...
			if (((jointMin != jointMin))){
				HX_STACK_LINE(421)
				HX_STACK_DO_THROW(HX_CSTRING("Error: DistanceJoint::jointMin cannot be NaN"));
			}
			HX_STACK_LINE(421)
			if (((jointMin < (int)0))){
				HX_STACK_LINE(421)
				HX_STACK_DO_THROW(HX_CSTRING("Error: DistanceJoint::jointMin must be >= 0"));
			}
			HX_STACK_LINE(421)
	...
	HX_STACK_LINE(422)
	{
		HX_STACK_LINE(422)
		{
			...
			if (((jointMax != jointMax))){
				HX_STACK_LINE(422)
				HX_STACK_DO_THROW(HX_CSTRING("Error: DistanceJoint::jointMax cannot be NaN"));
			}
			HX_STACK_LINE(422)
			if (((jointMax < (int)0))){
				HX_STACK_LINE(422)
				HX_STACK_DO_THROW(HX_CSTRING("Error: DistanceJoint::jointMax must be >= 0"));
			}
			HX_STACK_LINE(422)
...
bool DistanceJoint_obj::isSlack( ){
	...
	if (((bool((((  (((this->zpp_inner_zn->b1 == null()))) ? ::nape::phys::Body(null()) : ::nape::phys::Body(this->zpp_inner_zn->b1->outer) )) == null())) || bool((((  (((this->zpp_inner_zn->b2 == null()))) ? ::nape::phys::Body(null()) : ::nape::phys::Body(this->zpp_inner_zn->b2->outer) )) == null()))))){
		HX_STACK_LINE(385)
		HX_STACK_DO_THROW(HX_CSTRING("Error: Cannot compute slack for DistanceJoint if either body is null."));
	}
	HX_STACK_LINE(388)
...
::nape::geom::Vec3 DistanceJoint_obj::bodyImpulse( ::nape::phys::Body body){
	HX_STACK_FRAME("nape.constraint.DistanceJoint","bodyImpulse",0x8dd661ef,"nape.constraint.DistanceJoint.bodyImpulse","nape/constraint/DistanceJoint.hx",437,0x7df58474)
	HX_STACK_THIS(this)
