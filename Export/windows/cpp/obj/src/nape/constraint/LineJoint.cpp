...
HX_STACK_ARG(jointMax,"jointMax")
{
	...
	HX_STACK_LINE(447)
	{
		HX_STACK_LINE(447)
		{
			...
			if (((direction == null()))){
				HX_STACK_LINE(447)
				HX_STACK_DO_THROW(HX_CSTRING("Error: Constraint::direction cannot be null"));
			}
			HX_STACK_LINE(447)
			{
				HX_STACK_LINE(447)
	...
	HX_STACK_LINE(448)
	{
		HX_STACK_LINE(448)
		{
			...
			if (((jointMin != jointMin))){
				HX_STACK_LINE(448)
				HX_STACK_DO_THROW(HX_CSTRING("Error: AngleJoint::jointMin cannot be NaN"));
			}
			HX_STACK_LINE(448)
	...
	HX_STACK_LINE(449)
	{
		HX_STACK_LINE(449)
		{
			...
			if (((jointMax != jointMax))){
				HX_STACK_LINE(449)
				HX_STACK_DO_THROW(HX_CSTRING("Error: AngleJoint::jointMax cannot be NaN"));
			}
			HX_STACK_LINE(449)
...
::nape::geom::Vec3 LineJoint_obj::bodyImpulse( ::nape::phys::Body body){
	HX_STACK_FRAME("nape.constraint.LineJoint","bodyImpulse",0x465fc7d0,"nape.constraint.LineJoint.bodyImpulse","nape/constraint/LineJoint.hx",465,0xe7850eb3)
	HX_STACK_THIS(this)
