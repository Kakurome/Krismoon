...
Float ratio = __o_ratio.Default(1.0);
{
	...
	HX_STACK_LINE(391)
	{
		HX_STACK_LINE(391)
		{
			...
			if (((ratio != ratio))){
				HX_STACK_LINE(391)
				HX_STACK_DO_THROW(HX_CSTRING("Error: AngleJoint::ratio cannot be NaN"));
			}
			HX_STACK_LINE(391)
...
bool AngleJoint_obj::isSlack( ){
	...
	if (((bool((((  (((this->zpp_inner_zn->b1 == null()))) ? ::nape::phys::Body(null()) : ::nape::phys::Body(this->zpp_inner_zn->b1->outer) )) == null())) || bool((((  (((this->zpp_inner_zn->b2 == null()))) ? ::nape::phys::Body(null()) : ::nape::phys::Body(this->zpp_inner_zn->b2->outer) )) == null()))))){
		HX_STACK_LINE(356)
		HX_STACK_DO_THROW(HX_CSTRING("Error: Cannot compute slack for AngleJoint if either body is null."));
	}
	HX_STACK_LINE(359)
...
::nape::geom::Vec3 AngleJoint_obj::bodyImpulse( ::nape::phys::Body body){
	HX_STACK_FRAME("nape.constraint.AngleJoint","bodyImpulse",0xd69f28c7,"nape.constraint.AngleJoint.bodyImpulse","nape/constraint/AngleJoint.hx",408,0x60e8d95c)
	HX_STACK_THIS(this)
...
Void AngleJoint_obj::visitBodies( Dynamic lambda){
{
		...
		if (((lambda == null()))){
			HX_STACK_LINE(430)
			HX_STACK_DO_THROW(HX_CSTRING("Error: Cannot apply null lambda to bodies"));
		}
		HX_STACK_LINE(433)
