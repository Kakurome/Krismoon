...
Float ratio = __o_ratio.Default(1.0);
{
	...
	HX_STACK_LINE(580)
	{
		HX_STACK_LINE(580)
		{
			...
			if (((anchor1 == null()))){
				HX_STACK_LINE(580)
				HX_STACK_DO_THROW(HX_CSTRING("Error: Constraint::anchor1 cannot be null"));
			}
			HX_STACK_LINE(580)
			{
				HX_STACK_LINE(580)
	...
	HX_STACK_LINE(581)
	{
		HX_STACK_LINE(581)
		{
			...
			if (((anchor2 == null()))){
				HX_STACK_LINE(581)
				HX_STACK_DO_THROW(HX_CSTRING("Error: Constraint::anchor2 cannot be null"));
			}
			HX_STACK_LINE(581)
			{
				HX_STACK_LINE(581)
	...
	HX_STACK_LINE(582)
	{
		HX_STACK_LINE(582)
		{
			...
			if (((anchor3 == null()))){
				HX_STACK_LINE(582)
				HX_STACK_DO_THROW(HX_CSTRING("Error: Constraint::anchor3 cannot be null"));
			}
			HX_STACK_LINE(582)
			{
				HX_STACK_LINE(582)
				...
				HX_STACK_LINE(582)
				{
					...
					HX_STACK_LINE(582)
					if ((!(((  (((_g5 == x))) ? bool(_Function_5_1::Block(y,_this)) : bool(false) ))))){
						HX_STACK_LINE(582)
						{
							HX_STACK_LINE(582)
							_this->zpp_inner->x = x;
	...
	HX_STACK_LINE(583)
	{
		HX_STACK_LINE(583)
		{
			...
			if (((anchor4 == null()))){
				HX_STACK_LINE(583)
				HX_STACK_DO_THROW(HX_CSTRING("Error: Constraint::anchor4 cannot be null"));
			}
			HX_STACK_LINE(583)
			{
				HX_STACK_LINE(583)
				...
				HX_STACK_LINE(583)
				{
					...
					HX_STACK_LINE(583)
					if ((!(((  (((_g7 == x))) ? bool(_Function_5_1::Block(y,_this)) : bool(false) ))))){
						HX_STACK_LINE(583)
						{
							HX_STACK_LINE(583)
							_this->zpp_inner->x = x;
	...
	HX_STACK_LINE(584)
	{
		HX_STACK_LINE(584)
		{
			...
			if (((ratio != ratio))){
				HX_STACK_LINE(584)
				HX_STACK_DO_THROW(HX_CSTRING("Error: PulleyJoint::ratio cannot be NaN"));
			}
			HX_STACK_LINE(584)
	...
	HX_STACK_LINE(585)
	{
		HX_STACK_LINE(585)
		{
			...
			if (((jointMin != jointMin))){
				HX_STACK_LINE(585)
				HX_STACK_DO_THROW(HX_CSTRING("Error: PulleyJoint::jointMin cannot be NaN"));
			}
			HX_STACK_LINE(585)
			if (((jointMin < (int)0))){
				HX_STACK_LINE(585)
				HX_STACK_DO_THROW(HX_CSTRING("Error: PulleyJoint::jointMin must be >= 0"));
			}
			HX_STACK_LINE(585)
	...
	HX_STACK_LINE(586)
	{
		HX_STACK_LINE(586)
		{
			...
			if (((jointMax != jointMax))){
				HX_STACK_LINE(586)
				HX_STACK_DO_THROW(HX_CSTRING("Error: PulleyJoint::jointMax cannot be NaN"));
			}
			HX_STACK_LINE(586)
			if (((jointMax < (int)0))){
				HX_STACK_LINE(586)
				HX_STACK_DO_THROW(HX_CSTRING("Error: PulleyJoint::jointMax must be >= 0"));
			}
			HX_STACK_LINE(586)
...
bool PulleyJoint_obj::isSlack( ){
	...
	if (((bool((bool((bool((((  (((this->zpp_inner_zn->b1 == null()))) ? ::nape::phys::Body(null()) : ::nape::phys::Body(this->zpp_inner_zn->b1->outer) )) == null())) || bool((((  (((this->zpp_inner_zn->b2 == null()))) ? ::nape::phys::Body(null()) : ::nape::phys::Body(this->zpp_inner_zn->b2->outer) )) == null())))) || bool((((  (((this->zpp_inner_zn->b3 == null()))) ? ::nape::phys::Body(null()) : ::nape::phys::Body(this->zpp_inner_zn->b3->outer) )) == null())))) || bool((((  (((this->zpp_inner_zn->b4 == null()))) ? ::nape::phys::Body(null()) : ::nape::phys::Body(this->zpp_inner_zn->b4->outer) )) == null()))))){
		HX_STACK_LINE(539)
		HX_STACK_DO_THROW(HX_CSTRING("Error: Cannot compute slack for PulleyJoint if either body is null."));
	}
	HX_STACK_LINE(542)
...
::nape::geom::MatMN PulleyJoint_obj::impulse( ){
	...
	HX_STACK_LINE(595)
	{
		...
		if (((bool(((int)0 >= ret->zpp_inner->m)) || bool(((int)0 >= ret->zpp_inner->n))))){
			HX_STACK_LINE(595)
			HX_STACK_DO_THROW(HX_CSTRING("Error: MatMN indices out of range"));
		}
		HX_STACK_LINE(595)
...
::nape::geom::Vec3 PulleyJoint_obj::bodyImpulse( ::nape::phys::Body body){
	HX_STACK_FRAME("nape.constraint.PulleyJoint","bodyImpulse",0xe78339eb,"nape.constraint.PulleyJoint.bodyImpulse","nape/constraint/PulleyJoint.hx",601,0x2d6ef3f8)
	HX_STACK_THIS(this)
	HX_STACK_ARG(body,"body")
	HX_STACK_LINE(603)
	if (((body == null()))){
		HX_STACK_LINE(604)
		HX_STACK_DO_THROW(HX_CSTRING("Error: Cannot evaluate impulse on null body"));
	}
	HX_STACK_LINE(606)
	if (((bool((bool((bool((body != ((  (((this->zpp_inner_zn->b1 == null()))) ? ::nape::phys::Body(null()) : ::nape::phys::Body(this->zpp_inner_zn->b1->outer) )))) && bool((body != ((  (((this->zpp_inner_zn->b2 == null()))) ? ::nape::phys::Body(null()) : ::nape::phys::Body(this->zpp_inner_zn->b2->outer) )))))) && bool((body != ((  (((this->zpp_inner_zn->b3 == null()))) ? ::nape::phys::Body(null()) : ::nape::phys::Body(this->zpp_inner_zn->b3->outer) )))))) && bool((body != ((  (((this->zpp_inner_zn->b4 == null()))) ? ::nape::phys::Body(null()) : ::nape::phys::Body(this->zpp_inner_zn->b4->outer) ))))))){
		HX_STACK_LINE(607)
		HX_STACK_DO_THROW(HX_CSTRING("Error: Body is not linked to this constraint"));
	}
	HX_STACK_LINE(610)
