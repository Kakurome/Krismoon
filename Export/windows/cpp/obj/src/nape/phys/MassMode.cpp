...
{
HX_STACK_FRAME("nape.phys.MassMode","new",0x1df9921f,"nape.phys.MassMode.new","nape/phys/MassMode.hx",183,0x8a4995d1)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(183)
	if ((!(::zpp_nape::util::ZPP_Flags_obj::internal))){
		HX_STACK_LINE(183)
		HX_STACK_DO_THROW(HX_CSTRING("Error: Cannot instantiate MassMode derp!"));
	}
}
;
	return null();
