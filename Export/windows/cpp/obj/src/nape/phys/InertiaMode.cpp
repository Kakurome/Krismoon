...
{
HX_STACK_FRAME("nape.phys.InertiaMode","new",0xdfed1f79,"nape.phys.InertiaMode.new","nape/phys/InertiaMode.hx",183,0x22437677)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(183)
	if ((!(::zpp_nape::util::ZPP_Flags_obj::internal))){
		HX_STACK_LINE(183)
		HX_STACK_DO_THROW(HX_CSTRING("Error: Cannot instantiate InertiaMode derp!"));
	}
}
;
	return null();
