...
Float rollingFriction = __o_rollingFriction.Default(0.001);
{
	...
	HX_STACK_LINE(248)
	{
		...
		if (((elasticity != this->zpp_inner->elasticity))){
			...
			if (((elasticity != elasticity))){
				HX_STACK_LINE(248)
				HX_STACK_DO_THROW(HX_CSTRING("Error: Material::elasticity cannot be NaN"));
			}
			HX_STACK_LINE(248)
	...
	HX_STACK_LINE(249)
	{
		...
		if (((dynamicFriction != this->zpp_inner->dynamicFriction))){
			...
			if (((dynamicFriction != dynamicFriction))){
				HX_STACK_LINE(249)
				HX_STACK_DO_THROW(HX_CSTRING("Error: Material::dynamicFriction cannot be NaN"));
			}
			HX_STACK_LINE(249)
			if (((dynamicFriction < (int)0))){
				HX_STACK_LINE(249)
				HX_STACK_DO_THROW(HX_CSTRING("Error: Material::dynamicFriction cannot be negative"));
			}
			HX_STACK_LINE(249)
	...
	HX_STACK_LINE(250)
	{
		...
		if (((staticFriction != this->zpp_inner->staticFriction))){
			...
			if (((staticFriction != staticFriction))){
				HX_STACK_LINE(250)
				HX_STACK_DO_THROW(HX_CSTRING("Error: Material::staticFriction cannot be NaN"));
			}
			HX_STACK_LINE(250)
			if (((staticFriction < (int)0))){
				HX_STACK_LINE(250)
				HX_STACK_DO_THROW(HX_CSTRING("Error: Material::staticFriction cannot be negative"));
			}
			HX_STACK_LINE(250)
	...
	HX_STACK_LINE(251)
	{
		...
		if (((density != (this->zpp_inner->density * (int)1000)))){
			...
			if (((density != density))){
				HX_STACK_LINE(251)
				HX_STACK_DO_THROW(HX_CSTRING("Error: Material::density cannot be NaN"));
			}
			HX_STACK_LINE(251)
			if (((density < (int)0))){
				HX_STACK_LINE(251)
				HX_STACK_DO_THROW(HX_CSTRING("Error: Material::density must be positive"));
			}
			HX_STACK_LINE(251)
			if (((density < (int)0))){
				HX_STACK_LINE(251)
				HX_STACK_DO_THROW(HX_CSTRING("Error: Material::density cannot be negative"));
			}
			HX_STACK_LINE(251)
	...
	HX_STACK_LINE(252)
	{
		...
		if (((rollingFriction != this->zpp_inner->rollingFriction))){
			...
			if (((rollingFriction != rollingFriction))){
				HX_STACK_LINE(252)
				HX_STACK_DO_THROW(HX_CSTRING("Error: Material::rollingFriction cannot be NaN"));
			}
			HX_STACK_LINE(252)
			if (((rollingFriction < (int)0))){
				HX_STACK_LINE(252)
				HX_STACK_DO_THROW(HX_CSTRING("Error: Material::rollingFriction cannot be negative"));
			}
			HX_STACK_LINE(252)
