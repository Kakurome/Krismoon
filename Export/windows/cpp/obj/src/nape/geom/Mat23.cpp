...
Float ty = __o_ty.Default(0.0);
{
	...
	HX_STACK_LINE(373)
	{
		HX_STACK_LINE(373)
		{
			...
			if (((a != a))){
				HX_STACK_LINE(373)
				HX_STACK_DO_THROW(HX_CSTRING("Error: Mat23::a cannot be NaN"));
			}
			HX_STACK_LINE(373)
			this->zpp_inner->a = a;
			HX_STACK_LINE(373)
	...
	HX_STACK_LINE(374)
	{
		HX_STACK_LINE(374)
		{
			...
			if (((b != b))){
				HX_STACK_LINE(374)
				HX_STACK_DO_THROW(HX_CSTRING("Error: Mat23::b cannot be NaN"));
			}
			HX_STACK_LINE(374)
			this->zpp_inner->b = b;
			HX_STACK_LINE(374)
	...
	HX_STACK_LINE(375)
	{
		HX_STACK_LINE(375)
		{
			...
			if (((tx != tx))){
				HX_STACK_LINE(375)
				HX_STACK_DO_THROW(HX_CSTRING("Error: Mat23::tx cannot be NaN"));
			}
			HX_STACK_LINE(375)
	...
	HX_STACK_LINE(376)
	{
		HX_STACK_LINE(376)
		{
			...
			if (((c != c))){
				HX_STACK_LINE(376)
				HX_STACK_DO_THROW(HX_CSTRING("Error: Mat23::c cannot be NaN"));
			}
			HX_STACK_LINE(376)
			this->zpp_inner->c = c;
			HX_STACK_LINE(376)
	...
	HX_STACK_LINE(377)
	{
		HX_STACK_LINE(377)
		{
			...
			if (((d != d))){
				HX_STACK_LINE(377)
				HX_STACK_DO_THROW(HX_CSTRING("Error: Mat23::d cannot be NaN"));
			}
			HX_STACK_LINE(377)
			this->zpp_inner->d = d;
			HX_STACK_LINE(377)
	...
	HX_STACK_LINE(378)
	{
		HX_STACK_LINE(378)
		{
			...
			if (((ty != ty))){
				HX_STACK_LINE(378)
				HX_STACK_DO_THROW(HX_CSTRING("Error: Mat23::ty cannot be NaN"));
			}
			HX_STACK_LINE(378)
...
::nape::geom::Mat23 Mat23_obj::set( ::nape::geom::Mat23 matrix){
	...
	if (((matrix == null()))){
		HX_STACK_LINE(399)
		HX_STACK_DO_THROW(HX_CSTRING("Error: Cannot set form null matrix"));
	}
	HX_STACK_LINE(402)
	{
		HX_STACK_LINE(402)
...
::nape::geom::Mat23 Mat23_obj::inverse( ){
	...
	if ((this->singular())){
		HX_STACK_LINE(580)
		HX_STACK_DO_THROW(HX_CSTRING("Error: Matrix is singular and cannot be inverted"));
	}
	HX_STACK_LINE(583)
...
::nape::geom::Mat23 Mat23_obj::concat( ::nape::geom::Mat23 matrix){
	...
	if (((m == null()))){
		HX_STACK_LINE(626)
		HX_STACK_DO_THROW(HX_CSTRING("Error: Cannot concatenate with null Mat23"));
	}
	HX_STACK_LINE(629)
	...
	HX_STACK_ARG(weak,"weak")
{
		...
		if ((this->singular())){
			HX_STACK_LINE(713)
			HX_STACK_DO_THROW(HX_CSTRING("Error: Matrix is singular and inverse transformation cannot be performed"));
		}
		HX_STACK_LINE(716)
		Float idet = (Float(1.0) / Float((((this->zpp_inner->a * this->zpp_inner->d) - (this->zpp_inner->b * this->zpp_inner->c)))));		HX_STACK_VAR(idet,"idet");
		HX_STACK_LINE(717)
...
::nape::geom::Mat23 Mat23_obj::equiorthogonalise( ){
	...
	if ((!(this->equiorthogonal()))){
		...
		if (((bool(((k1 * k1) < ::nape::Config_obj::epsilon)) || bool(((k2 * k2) < ::nape::Config_obj::epsilon))))){
			HX_STACK_LINE(823)
			HX_STACK_DO_THROW(HX_CSTRING("Error: Matrix is singular and cannot be equiorthogonalised"));
		}
		HX_STACK_LINE(826)
...
::nape::geom::Mat23 Mat23_obj::orthogonalise( ){
	...
	if ((!(this->orthogonal()))){
		...
		if (((bool(((k1 * k1) < ::nape::Config_obj::epsilon)) || bool(((k2 * k2) < ::nape::Config_obj::epsilon))))){
			HX_STACK_LINE(868)
			HX_STACK_DO_THROW(HX_CSTRING("Error: Matrix is singular and cannot be orthogonalised"));
		}
		HX_STACK_LINE(871)
...
::nape::geom::Mat23 Mat23_obj::rotation( Float angle){
	...
	if (((angle != angle))){
		HX_STACK_LINE(493)
		HX_STACK_DO_THROW(HX_CSTRING("Error: Cannot create rotation matrix with NaN angle"));
	}
	HX_STACK_LINE(496)
