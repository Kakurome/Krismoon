...
HX_STACK_THIS(this)
{
	...
	if ((!(::zpp_nape::geom::ZPP_ConvexRayResult_obj::internal))){
		HX_STACK_LINE(236)
		HX_STACK_DO_THROW(HX_CSTRING("Error: RayResult cannot be instantiated derp!"));
	}
}
;
	return null();
...
::String RayResult_obj::toString( ){
	...
	HX_STACK_LINE(256)
	::nape::shape::Shape _g;		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(256)
	{
		HX_STACK_LINE(256)
		if (((this->zpp_inner->next != null()))){
		...
		HX_STACK_LINE(256)
		_g = this->zpp_inner->shape;
	}
	HX_STACK_LINE(256)
	::String _g1 = ::Std_obj::string(_g);		HX_STACK_VAR(_g1,"_g1");
	HX_STACK_LINE(256)
	::String _g2 = (HX_CSTRING("{ shape: ") + _g1);		HX_STACK_VAR(_g2,"_g2");
	HX_STACK_LINE(256)
	::String _g3 = (_g2 + HX_CSTRING(" distance: "));		HX_STACK_VAR(_g3,"_g3");
	HX_STACK_LINE(256)
	...
	HX_STACK_LINE(256)
	{
		...
		HX_STACK_LINE(256)
		_g4 = this->zpp_inner->toiDistance;
	}
	HX_STACK_LINE(256)
	::String _g5 = (_g3 + _g4);		HX_STACK_VAR(_g5,"_g5");
	HX_STACK_LINE(256)
	::String _g6 = (_g5 + HX_CSTRING(" ?inner: "));		HX_STACK_VAR(_g6,"_g6");
	HX_STACK_LINE(256)
