...
Float Vec3_obj::set_length( Float length){
	...
	HX_STACK_LINE(466)
	{
		...
		HX_STACK_LINE(480)
		{
			...
			HX_STACK_LINE(481)
			{
				...
				HX_STACK_LINE(481)
				_g22 = ::Math_obj::sqrt(_g21);
			}
			HX_STACK_LINE(481)
			Float t = (Float(length) / Float(_g22));		HX_STACK_VAR(t,"t");
			HX_STACK_LINE(482)
			{
				HX_STACK_LINE(483)
				...
				{
					HX_STACK_LINE(492)
					::nape::geom::Vec3 _g11 = hx::ObjectPtr<OBJ_>(this);		HX_STACK_VAR(_g11,"_g11");
					HX_STACK_LINE(492)
					{
						HX_STACK_LINE(492)
						...
						{
							HX_STACK_LINE(492)
							if (((bool((_g11 != null())) && bool(_g11->zpp_disp)))){
								HX_STACK_LINE(492)
								HX_STACK_DO_THROW(HX_CSTRING("Error: Vec3 has been disposed and cannot be used!"));
							}
							HX_STACK_LINE(492)
							{
								HX_STACK_LINE(492)
								::zpp_nape::geom::ZPP_Vec3 _this = _g11->zpp_inner;		HX_STACK_VAR(_this,"_this");
								HX_STACK_LINE(492)
								if (((_this->_validate != null()))){
									HX_STACK_LINE(492)
									_this->_validate();
							...
							HX_STACK_LINE(492)
							_g23 = _g11->zpp_inner->x;
						}
						HX_STACK_LINE(492)
						Float x = (_g23 * t1);		HX_STACK_VAR(x,"x");
						HX_STACK_LINE(492)
						{
							HX_STACK_LINE(492)
							if (((bool((_g11 != null())) && bool(_g11->zpp_disp)))){
				...
				HX_STACK_LINE(493)
				{
					...
					HX_STACK_LINE(493)
					{
						...
						HX_STACK_LINE(493)
						{
							...
							HX_STACK_LINE(493)
							_g24 = _g11->zpp_inner->y;
						}
						HX_STACK_LINE(493)
						Float y = (_g24 * t1);		HX_STACK_VAR(y,"y");
						HX_STACK_LINE(493)
						{
							HX_STACK_LINE(493)
							if (((bool((_g11 != null())) && bool(_g11->zpp_disp)))){
			...
			HX_STACK_LINE(495)
			{
				...
				HX_STACK_LINE(495)
				{
					...
					HX_STACK_LINE(495)
					{
						...
						HX_STACK_LINE(495)
						_g25 = _g11->zpp_inner->z;
					}
					HX_STACK_LINE(495)
					Float z = (_g25 * t);		HX_STACK_VAR(z,"z");
					HX_STACK_LINE(495)
					{
						HX_STACK_LINE(495)
						if (((bool((_g11 != null())) && bool(_g11->zpp_disp)))){
	...
	HX_STACK_LINE(498)
	{
		...
		HX_STACK_LINE(498)
		_g34 = this->zpp_inner->z;
	}
	HX_STACK_LINE(498)
	Float _g35 = (_g33 * _g34);		HX_STACK_VAR(_g35,"_g35");
	HX_STACK_LINE(498)
	Float _g36 = (_g32 + _g35);		HX_STACK_VAR(_g36,"_g36");
	HX_STACK_LINE(498)
	return ::Math_obj::sqrt(_g36);
}
...
static hx::StorageInfo sMemberStorageInfo[] = {
	...
	{hx::fsBool,(int)offsetof(Vec3_obj,zpp_disp),HX_CSTRING("zpp_disp")},
	{ hx::fsUnknown, 0, null()}
};
#endif
