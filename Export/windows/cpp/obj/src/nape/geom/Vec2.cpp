...
Float Vec2_obj::set_x( Float x){
	...
	HX_STACK_LINE(533)
	{
		...
		if (((_g != x))){
			...
			if (((x != x))){
				HX_STACK_LINE(543)
				HX_STACK_DO_THROW(HX_CSTRING("Error: Vec2::x cannot be NaN"));
			}
			HX_STACK_LINE(546)
			this->zpp_inner->x = x;
			HX_STACK_LINE(547)
...
Float Vec2_obj::set_y( Float y){
	...
	HX_STACK_LINE(569)
	{
		...
		if (((_g != y))){
			...
			if (((y != y))){
				HX_STACK_LINE(579)
				HX_STACK_DO_THROW(HX_CSTRING("Error: Vec2::y cannot be NaN"));
			}
			HX_STACK_LINE(582)
			this->zpp_inner->y = y;
			HX_STACK_LINE(583)
...
Float Vec2_obj::set_length( Float length){
	...
	HX_STACK_LINE(608)
	{
		...
		if (((length != length))){
			HX_STACK_LINE(617)
			HX_STACK_DO_THROW(HX_CSTRING("Error: Vec2::length cannot be NaN"));
		}
		HX_STACK_LINE(619)
		Float _g;		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(619)
		...
		HX_STACK_LINE(623)
		{
			...
			HX_STACK_LINE(624)
			Float t = (Float(length) / Float(_g14));		HX_STACK_VAR(t,"t");
			HX_STACK_LINE(633)
			{
				HX_STACK_LINE(633)
				::nape::geom::Vec2 _g15 = hx::ObjectPtr<OBJ_>(this);		HX_STACK_VAR(_g15,"_g15");
				HX_STACK_LINE(633)
				{
					HX_STACK_LINE(633)
					...
					{
						HX_STACK_LINE(633)
						if (((bool((_g15 != null())) && bool(_g15->zpp_disp)))){
							HX_STACK_LINE(633)
							HX_STACK_DO_THROW(HX_CSTRING("Error: Vec2 has been disposed and cannot be used!"));
						}
						HX_STACK_LINE(633)
						{
							HX_STACK_LINE(633)
							::zpp_nape::geom::ZPP_Vec2 _this = _g15->zpp_inner;		HX_STACK_VAR(_this,"_this");
							HX_STACK_LINE(633)
							if (((_this->_validate != null()))){
								HX_STACK_LINE(633)
								_this->_validate();
						...
						HX_STACK_LINE(633)
						_g151 = _g15->zpp_inner->x;
					}
					HX_STACK_LINE(633)
					Float x = (_g151 * t);		HX_STACK_VAR(x,"x");
					HX_STACK_LINE(633)
					{
						HX_STACK_LINE(633)
						if (((bool((_g15 != null())) && bool(_g15->zpp_disp)))){
			...
			HX_STACK_LINE(634)
			{
				...
				HX_STACK_LINE(634)
				{
					...
					HX_STACK_LINE(634)
					{
						...
						HX_STACK_LINE(634)
						_g17 = _g15->zpp_inner->y;
					}
					HX_STACK_LINE(634)
					Float y = (_g17 * t);		HX_STACK_VAR(y,"y");
					HX_STACK_LINE(634)
					{
						HX_STACK_LINE(634)
						if (((bool((_g15 != null())) && bool(_g15->zpp_disp)))){
...
Float Vec2_obj::set_angle( Float angle){
	...
	HX_STACK_LINE(875)
	{
		...
		if (((angle != angle))){
			HX_STACK_LINE(884)
			HX_STACK_DO_THROW(HX_CSTRING("Error: Vec2::angle cannot be NaN"));
		}
		HX_STACK_LINE(887)
...
::nape::geom::Vec2 Vec2_obj::rotate( Float angle){
	...
	if (((angle != angle))){
		HX_STACK_LINE(916)
		HX_STACK_DO_THROW(HX_CSTRING("Error: Cannot rotate Vec2 by NaN"));
	}
	HX_STACK_LINE(919)
	...
	HX_STACK_ARG(weak,"weak")
{
		...
		if (((_g7 == (int)0))){
			HX_STACK_LINE(955)
			HX_STACK_DO_THROW(HX_CSTRING("Error: Cannot reflect in zero vector"));
		}
		struct _Function_1_1{
						...
						inline static ::nape::geom::Vec2 Block( hx::ObjectPtr< ::nape::geom::Vec2_obj > __this){
							HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/geom/Vec2.hx",958,0x020b6534)
							{
								...
								if (((ret->zpp_inner == null()))){
									...
									HX_STACK_LINE(958)
									if ((!(((  (((_g11 == x))) ? bool(_Function_4_1::Block(ret,y)) : bool(false) ))))){
										HX_STACK_LINE(958)
										{
											HX_STACK_LINE(958)
											ret->zpp_inner->x = x;
		...
		HX_STACK_LINE(959)
		Float _g13 = normal->dot(vec);		HX_STACK_VAR(_g13,"_g13");
		HX_STACK_LINE(959)
		Float _g14 = ((int)2 * _g13);		HX_STACK_VAR(_g14,"_g14");
		HX_STACK_LINE(959)
		::nape::geom::Vec2 _g15 = normal->muleq(_g14);		HX_STACK_VAR(_g15,"_g15");
		HX_STACK_LINE(959)
		::nape::geom::Vec2 ret = vec->sub(_g15,weak);		HX_STACK_VAR(ret,"ret");
		HX_STACK_LINE(960)
...
::nape::geom::Vec2 Vec2_obj::normalise( ){
	...
	if (((_g7 == (int)0))){
		HX_STACK_LINE(993)
		HX_STACK_DO_THROW(HX_CSTRING("Error: Cannot normalise vector of length 0"));
	}
	HX_STACK_LINE(996)
	{
		HX_STACK_LINE(997)
		...
		HX_STACK_LINE(997)
		Float d = (_g10 + _g13);		HX_STACK_VAR(d,"d");
		HX_STACK_LINE(1006)
		Float _g14 = ::Math_obj::sqrt(d);		HX_STACK_VAR(_g14,"_g14");
		HX_STACK_LINE(1006)
		Float imag = (Float(1.0) / Float(_g14));		HX_STACK_VAR(imag,"imag");
		HX_STACK_LINE(1007)
		{
			HX_STACK_LINE(1008)
			...
			HX_STACK_LINE(1017)
			{
				...
				HX_STACK_LINE(1017)
				{
					...
					HX_STACK_LINE(1017)
					Float x = (_g15 * t);		HX_STACK_VAR(x,"x");
					HX_STACK_LINE(1017)
					{
						HX_STACK_LINE(1017)
						if (((bool((_g != null())) && bool(_g->zpp_disp)))){
	...
	HX_STACK_ARG(weak,"weak")
{
		...
		HX_STACK_LINE(1046)
		{
			...
			Float _g13 = (_g11 * _g12);		HX_STACK_VAR(_g13,"_g13");
			HX_STACK_LINE(1046)
			Float x = (_g10 + _g13);		HX_STACK_VAR(x,"x");
			HX_STACK_LINE(1046)
			_g14 = ::Math_obj::sqrt(x);
		}
		HX_STACK_LINE(1046)
		Float scale = (Float((int)1) / Float(_g14));		HX_STACK_VAR(scale,"scale");
		HX_STACK_LINE(1047)
		Float _g15;		HX_STACK_VAR(_g15,"_g15");
		HX_STACK_LINE(1047)
		{
		...
		HX_STACK_LINE(1047)
		Float x = (_g15 * scale);		HX_STACK_VAR(x,"x");
		HX_STACK_LINE(1047)
		Float _g16;		HX_STACK_VAR(_g16,"_g16");
		HX_STACK_LINE(1047)
		{
		...
		HX_STACK_LINE(1047)
		Float y = (_g16 * scale);		HX_STACK_VAR(y,"y");
		HX_STACK_LINE(1047)
		if (((bool((x != x)) || bool((y != y))))){
			HX_STACK_LINE(1047)
			HX_STACK_DO_THROW(HX_CSTRING("Error: Vec2 components cannot be NaN"));
		...
		if (((::zpp_nape::util::ZPP_PubPool_obj::poolVec2 == null()))){
			HX_STACK_LINE(1047)
			::nape::geom::Vec2 _g17 = ::nape::geom::Vec2_obj::__new(null(),null());		HX_STACK_VAR(_g17,"_g17");
			HX_STACK_LINE(1047)
			ret = _g17;
		}
		else{
		...
		if (((ret->zpp_inner == null()))){
			...
			HX_STACK_LINE(1047)
			if ((!(((  (((_g20 == x))) ? bool(_Function_2_1::Block(ret,y)) : bool(false) ))))){
				HX_STACK_LINE(1047)
				{
					HX_STACK_LINE(1047)
					ret->zpp_inner->x = x;
	...
	HX_STACK_ARG(weak,"weak")
{
		...
		if (((vector == null()))){
			HX_STACK_LINE(1079)
			HX_STACK_DO_THROW(HX_CSTRING("Error: Cannot add null vectors"));
		}
		HX_STACK_LINE(1082)
		::nape::geom::Vec2 ret;		HX_STACK_VAR(ret,"ret");
		HX_STACK_LINE(1082)
	...
	HX_STACK_ARG(weak,"weak")
{
		...
		if (((vector == null()))){
			HX_STACK_LINE(1178)
			HX_STACK_DO_THROW(HX_CSTRING("Error: Cannot subtract null vectors"));
		}
		HX_STACK_LINE(1181)
		::nape::geom::Vec2 ret;		HX_STACK_VAR(ret,"ret");
		HX_STACK_LINE(1181)
	...
	HX_STACK_ARG(weak,"weak")
{
		...
		if (((scalar != scalar))){
			HX_STACK_LINE(1217)
			HX_STACK_DO_THROW(HX_CSTRING("Error: Cannot multiply with NaN"));
		}
		HX_STACK_LINE(1220)
		Float _g;		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(1220)
...
Float Vec2_obj::dot( ::nape::geom::Vec2 vector){
	...
	if (((vector == null()))){
		HX_STACK_LINE(1372)
		HX_STACK_DO_THROW(HX_CSTRING("Error: Cannot take dot product with null vector"));
	}
	HX_STACK_LINE(1375)
	Float _g;		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(1375)
...
Float Vec2_obj::cross( ::nape::geom::Vec2 vector){
	...
	if (((vector == null()))){
		HX_STACK_LINE(1432)
		HX_STACK_DO_THROW(HX_CSTRING("Error: Cannot take cross product with null vector"));
	}
	HX_STACK_LINE(1435)
	Float _g;		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(1435)
	...
	HX_STACK_ARG(weak,"weak")
{
		...
		if (((point == null()))){
			HX_STACK_LINE(455)
			HX_STACK_DO_THROW(HX_CSTRING("Error: Cannot create Vec2 from null Point object"));
		}
		HX_STACK_LINE(457)
		if (((bool((point->x != point->x)) || bool((point->y != point->y))))){
			HX_STACK_LINE(458)
			HX_STACK_DO_THROW(HX_CSTRING("Error: Error: Vec2 components cannot be NaN"));
		}
		HX_STACK_LINE(461)
...
Float Vec2_obj::dsq( ::nape::geom::Vec2 a,::nape::geom::Vec2 b){
	...
	if (((bool((a == null())) || bool((b == null()))))){
		HX_STACK_LINE(723)
		HX_STACK_DO_THROW(HX_CSTRING("Error: Cannot compute squared distance between null Vec2"));
	}
	HX_STACK_LINE(725)
...
static hx::StorageInfo sMemberStorageInfo[] = {
	...
	{hx::fsBool,(int)offsetof(Vec2_obj,zpp_disp),HX_CSTRING("zpp_disp")},
	{ hx::fsUnknown, 0, null()}
};
#endif
