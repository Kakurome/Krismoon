...
int precedence = __o_precedence.Default(0);
{
	...
	if (((handler == null()))){
		HX_STACK_LINE(348)
		HX_STACK_DO_THROW(HX_CSTRING("Error: InteractionListener::handler cannot be null"));
	}
	HX_STACK_LINE(350)
	if (((event == null()))){
		HX_STACK_LINE(351)
		HX_STACK_DO_THROW(HX_CSTRING("Error: CbEvent cannot be null for InteractionListener"));
	}
	HX_STACK_LINE(354)
	...
	if (((event == _g1))){
		...
		if (((event == _g3))){
			...
			if (((event == _g5))){
				...
				HX_STACK_LINE(360)
				::String _g6 = event->toString();		HX_STACK_VAR(_g6,"_g6");
				HX_STACK_LINE(360)
				::String _g7 = (HX_CSTRING("Error: CbEvent '") + _g6);		HX_STACK_VAR(_g7,"_g7");
				HX_STACK_LINE(360)
				HX_STACK_DO_THROW((_g7 + HX_CSTRING("' is not a valid event type for InteractionListener")));
			}
		}
	}
	HX_STACK_LINE(363)
	::nape::callbacks::OptionType _g8 = ::zpp_nape::callbacks::ZPP_OptionType_obj::argument(options1);		HX_STACK_VAR(_g8,"_g8");
	HX_STACK_LINE(363)
	::nape::callbacks::OptionType _g9 = ::zpp_nape::callbacks::ZPP_OptionType_obj::argument(options2);		HX_STACK_VAR(_g9,"_g9");
	HX_STACK_LINE(363)
	::zpp_nape::callbacks::ZPP_InteractionListener _g10 = ::zpp_nape::callbacks::ZPP_InteractionListener_obj::__new(_g8,_g9,xevent,::zpp_nape::util::ZPP_Flags_obj::id_ListenerType_INTERACTION);		HX_STACK_VAR(_g10,"_g10");
	HX_STACK_LINE(363)
	this->zpp_inner_zn = _g10;
	HX_STACK_LINE(364)
			...
			HX_STACK_LINE(369)
			{
				...
				if (((ret == ::zpp_nape::util::ZPP_Flags_obj::id_InteractionType_COLLISION))){
					...
					if (((ret == ::zpp_nape::util::ZPP_Flags_obj::id_InteractionType_SENSOR))){
						...
						HX_STACK_LINE(369)
						_g15 = ::zpp_nape::util::ZPP_Flags_obj::InteractionType_SENSOR;
					}
					else{
						HX_STACK_LINE(369)
						if (((ret == ::zpp_nape::util::ZPP_Flags_obj::id_InteractionType_FLUID))){
							...
							HX_STACK_LINE(369)
							_g15 = ::zpp_nape::util::ZPP_Flags_obj::InteractionType_FLUID;
						}
						else{
							HX_STACK_LINE(369)
							if (((ret == ::zpp_nape::util::ZPP_Flags_obj::id_InteractionType_ANY))){
								...
								HX_STACK_LINE(369)
								_g15 = ::zpp_nape::util::ZPP_Flags_obj::InteractionType_ANY;
							}
							else{
								HX_STACK_LINE(369)
								_g15 = null();
			...
			if (((_g15 != interactionType))){
				...
				HX_STACK_LINE(369)
				{
					...
					if (((::zpp_nape::util::ZPP_Flags_obj::InteractionType_COLLISION == null()))){
						...
						HX_STACK_LINE(369)
						::zpp_nape::util::ZPP_Flags_obj::InteractionType_COLLISION = _g16;
						HX_STACK_LINE(369)
						::zpp_nape::util::ZPP_Flags_obj::internal = false;
					}
					HX_STACK_LINE(369)
					_g17 = ::zpp_nape::util::ZPP_Flags_obj::InteractionType_COLLISION;
				}
				HX_STACK_LINE(369)
				...
				if (((interactionType == _g17))){
					...
					HX_STACK_LINE(369)
					{
						...
						if (((::zpp_nape::util::ZPP_Flags_obj::InteractionType_SENSOR == null()))){
							...
							HX_STACK_LINE(369)
							::zpp_nape::util::ZPP_Flags_obj::InteractionType_SENSOR = _g18;
							HX_STACK_LINE(369)
							::zpp_nape::util::ZPP_Flags_obj::internal = false;
						}
						HX_STACK_LINE(369)
						_g19 = ::zpp_nape::util::ZPP_Flags_obj::InteractionType_SENSOR;
					}
					HX_STACK_LINE(369)
					if (((interactionType == _g19))){
						...
						HX_STACK_LINE(369)
						::nape::callbacks::InteractionType _g21;		HX_STACK_VAR(_g21,"_g21");
						HX_STACK_LINE(369)
						{
							HX_STACK_LINE(369)
							if (((::zpp_nape::util::ZPP_Flags_obj::InteractionType_FLUID == null()))){
								...
								HX_STACK_LINE(369)
								::zpp_nape::util::ZPP_Flags_obj::InteractionType_FLUID = _g20;
								HX_STACK_LINE(369)
								::zpp_nape::util::ZPP_Flags_obj::internal = false;
							}
							HX_STACK_LINE(369)
							_g21 = ::zpp_nape::util::ZPP_Flags_obj::InteractionType_FLUID;
						}
						HX_STACK_LINE(369)
						if (((interactionType == _g21))){
							HX_STACK_LINE(369)
		...
		HX_STACK_LINE(369)
		{
			...
			if (((ret == ::zpp_nape::util::ZPP_Flags_obj::id_InteractionType_COLLISION))){
				...
				if (((::zpp_nape::util::ZPP_Flags_obj::InteractionType_COLLISION == null()))){
					...
					HX_STACK_LINE(369)
					::zpp_nape::util::ZPP_Flags_obj::InteractionType_COLLISION = _g22;
					HX_STACK_LINE(369)
					::zpp_nape::util::ZPP_Flags_obj::internal = false;
				}
				HX_STACK_LINE(369)
				...
				if (((ret == ::zpp_nape::util::ZPP_Flags_obj::id_InteractionType_SENSOR))){
					...
					if (((::zpp_nape::util::ZPP_Flags_obj::InteractionType_SENSOR == null()))){
						...
						HX_STACK_LINE(369)
						::zpp_nape::util::ZPP_Flags_obj::InteractionType_SENSOR = _g23;
						HX_STACK_LINE(369)
						::zpp_nape::util::ZPP_Flags_obj::internal = false;
					}
					HX_STACK_LINE(369)
					...
					if (((ret == ::zpp_nape::util::ZPP_Flags_obj::id_InteractionType_FLUID))){
						...
						if (((::zpp_nape::util::ZPP_Flags_obj::InteractionType_FLUID == null()))){
							...
							::zpp_nape::util::ZPP_Flags_obj::internal = true;
							HX_STACK_LINE(369)
							::nape::callbacks::InteractionType _g24 = ::nape::callbacks::InteractionType_obj::__new();		HX_STACK_VAR(_g24,"_g24");
							HX_STACK_LINE(369)
							::zpp_nape::util::ZPP_Flags_obj::InteractionType_FLUID = _g24;
							HX_STACK_LINE(369)
							::zpp_nape::util::ZPP_Flags_obj::internal = false;
						}
						HX_STACK_LINE(369)
						...
						if (((ret == ::zpp_nape::util::ZPP_Flags_obj::id_InteractionType_ANY))){
							...
							if (((::zpp_nape::util::ZPP_Flags_obj::InteractionType_ANY == null()))){
								...
								::zpp_nape::util::ZPP_Flags_obj::internal = true;
								HX_STACK_LINE(369)
								::nape::callbacks::InteractionType _g25 = ::nape::callbacks::InteractionType_obj::__new();		HX_STACK_VAR(_g25,"_g25");
								HX_STACK_LINE(369)
								::zpp_nape::util::ZPP_Flags_obj::InteractionType_ANY = _g25;
								HX_STACK_LINE(369)
								::zpp_nape::util::ZPP_Flags_obj::internal = false;
							}
							HX_STACK_LINE(369)
