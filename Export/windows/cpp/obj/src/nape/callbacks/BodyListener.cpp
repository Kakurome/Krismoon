...
int precedence = __o_precedence.Default(0);
{
	...
	if (((event == _g1))){
		...
		if (((event == _g3))){
			...
			HX_STACK_LINE(266)
			::String _g4 = event->toString();		HX_STACK_VAR(_g4,"_g4");
			HX_STACK_LINE(266)
			::String _g5 = (HX_CSTRING("Error: cbEvent '") + _g4);		HX_STACK_VAR(_g5,"_g5");
			HX_STACK_LINE(266)
			HX_STACK_DO_THROW((_g5 + HX_CSTRING("' is not a valid event type for a BodyListener")));
		}
	}
	HX_STACK_LINE(269)
	::nape::callbacks::OptionType _g6 = ::zpp_nape::callbacks::ZPP_OptionType_obj::argument(options);		HX_STACK_VAR(_g6,"_g6");
	HX_STACK_LINE(269)
	::zpp_nape::callbacks::ZPP_BodyListener _g7 = ::zpp_nape::callbacks::ZPP_BodyListener_obj::__new(_g6,xevent,handler);		HX_STACK_VAR(_g7,"_g7");
	HX_STACK_LINE(269)
