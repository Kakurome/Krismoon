...
{
HX_STACK_FRAME("nape.callbacks.ListenerType","new",0xec0b3486,"nape.callbacks.ListenerType.new","nape/callbacks/ListenerType.hx",183,0xddcbcca8)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(183)
	if ((!(::zpp_nape::util::ZPP_Flags_obj::internal))){
		HX_STACK_LINE(183)
		HX_STACK_DO_THROW(HX_CSTRING("Error: Cannot instantiate ListenerType derp!"));
	}
}
;
	return null();
