...
::nape::geom::Vec2 Space_obj::set_gravity( ::nape::geom::Vec2 gravity){
	...
	HX_STACK_LINE(214)
	{
		...
		if (((gravity == null()))){
			HX_STACK_LINE(221)
			HX_STACK_DO_THROW(HX_CSTRING("Error: Space::gravity cannot be null"));
		}
		HX_STACK_LINE(223)
		{
			HX_STACK_LINE(223)
...
Float Space_obj::set_worldAngularDrag( Float worldAngularDrag){
	...
	HX_STACK_LINE(276)
	{
		...
		if (((d != d))){
			HX_STACK_LINE(279)
			HX_STACK_DO_THROW(HX_CSTRING("Error: Space::worldAngularDrag cannot be NaN"));
		}
		HX_STACK_LINE(281)
...
Float Space_obj::set_worldLinearDrag( Float worldLinearDrag){
	...
	HX_STACK_LINE(299)
	{
		...
		if (((d != d))){
			HX_STACK_LINE(302)
			HX_STACK_DO_THROW(HX_CSTRING("Error: Space::worldLinearDrag cannot be NaN"));
		}
		HX_STACK_LINE(304)
...
Void Space_obj::visitBodies( Dynamic lambda){
{
		...
		if (((lambda == null()))){
			HX_STACK_LINE(385)
			HX_STACK_DO_THROW(HX_CSTRING("Error: lambda cannot be null for Space::visitBodies"));
		}
		HX_STACK_LINE(387)
		{
			HX_STACK_LINE(387)
...
Void Space_obj::visitConstraints( Dynamic lambda){
{
		...
		if (((lambda == null()))){
			HX_STACK_LINE(401)
			HX_STACK_DO_THROW(HX_CSTRING("Error: lambda cannot be null for Space::visitConstraints"));
		}
		HX_STACK_LINE(403)
		{
			HX_STACK_LINE(403)
...
Void Space_obj::visitCompounds( Dynamic lambda){
{
		...
		if (((lambda == null()))){
			HX_STACK_LINE(417)
			HX_STACK_DO_THROW(HX_CSTRING("Error: lambda cannot be null for Space::visitCompounds"));
		}
		HX_STACK_LINE(419)
		{
			HX_STACK_LINE(419)
...
Void Space_obj::clear( ){
{
		...
		if ((this->zpp_inner->midstep)){
			HX_STACK_LINE(477)
			HX_STACK_DO_THROW(HX_CSTRING("Error: Space::clear() cannot be called during space step()"));
		}
		HX_STACK_LINE(479)
	...
	HX_STACK_ARG(positionIterations,"positionIterations")
{
		...
		if (((deltaTime != deltaTime))){
			HX_STACK_LINE(503)
			HX_STACK_DO_THROW(HX_CSTRING("Error: deltaTime cannot be NaN"));
		}
		HX_STACK_LINE(504)
		if (((deltaTime <= (int)0))){
			HX_STACK_LINE(504)
			HX_STACK_DO_THROW(HX_CSTRING("Error: deltaTime must be strictly positive"));
		}
		HX_STACK_LINE(505)
		if (((velocityIterations <= (int)0))){
			HX_STACK_LINE(505)
			HX_STACK_DO_THROW(HX_CSTRING("Error: must use atleast one velocity iteration"));
		}
		HX_STACK_LINE(506)
		if (((positionIterations <= (int)0))){
			HX_STACK_LINE(506)
			HX_STACK_DO_THROW(HX_CSTRING("Error: must use atleast one position iteration"));
		}
		HX_STACK_LINE(508)
...
::nape::callbacks::InteractionType Space_obj::interactionType( ::nape::shape::Shape shape1,::nape::shape::Shape shape2){
	...
	if (((bool((shape1 == null())) || bool((shape2 == null()))))){
		HX_STACK_LINE(580)
		HX_STACK_DO_THROW(HX_CSTRING("Error: Cannot evaluate interaction type for null shapes"));
	}
	HX_STACK_LINE(583)
	if (((bool((((  (((shape1->zpp_inner->body != null()))) ? ::nape::phys::Body(shape1->zpp_inner->body->outer) : ::nape::phys::Body(null()) )) == null())) || bool((((  (((shape2->zpp_inner->body != null()))) ? ::nape::phys::Body(shape2->zpp_inner->body->outer) : ::nape::phys::Body(null()) )) == null()))))){
		HX_STACK_LINE(583)
		HX_STACK_DO_THROW(HX_CSTRING("Error: Cannot evaluate interaction type for shapes not part of a Body"));
	}
	HX_STACK_LINE(585)
...
::nape::shape::ShapeList Space_obj::shapesUnderPoint( ::nape::geom::Vec2 point,::nape::dynamics::InteractionFilter filter,::nape::shape::ShapeList output){
	...
	if (((point == null()))){
		HX_STACK_LINE(617)
		HX_STACK_DO_THROW(HX_CSTRING("Error: Cannot evaluate shapes under a null point :)"));
	}
	HX_STACK_LINE(619)
	Float _g;		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(619)
...
::nape::phys::BodyList Space_obj::bodiesUnderPoint( ::nape::geom::Vec2 point,::nape::dynamics::InteractionFilter filter,::nape::phys::BodyList output){
	...
	if (((point == null()))){
		HX_STACK_LINE(654)
		HX_STACK_DO_THROW(HX_CSTRING("Error: Cannot evaluate objects under a null point :)"));
	}
	HX_STACK_LINE(656)
	Float _g;		HX_STACK_VAR(_g,"_g");
	HX_STACK_LINE(656)
	...
	HX_STACK_ARG(output,"output")
{
		...
		if (((aabb == null()))){
			HX_STACK_LINE(692)
			HX_STACK_DO_THROW(HX_CSTRING("Error: Cannot evaluate shapes in a null AABB :)"));
		}
		HX_STACK_LINE(693)
		Float _g;		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(693)
		...
		struct _Function_1_1{
			inline static bool Block( ::nape::geom::AABB &aabb){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/space/Space.hx",693,0x769bc808)
				{
					HX_STACK_LINE(693)
					Float _g1;		HX_STACK_VAR(_g1,"_g1");
					HX_STACK_LINE(693)
		...
		HX_STACK_LINE(693)
		if (((  ((!(((_g == (int)0))))) ? bool(_Function_1_1::Block(aabb)) : bool(true) ))){
			HX_STACK_LINE(693)
			HX_STACK_DO_THROW(HX_CSTRING("Error: Cannot evaluate shapes in degenerate AABB :/"));
		}
		HX_STACK_LINE(695)
	...
	HX_STACK_ARG(output,"output")
{
		...
		if (((aabb == null()))){
			HX_STACK_LINE(720)
			HX_STACK_DO_THROW(HX_CSTRING("Error: Cannot evaluate objects in a null AABB :)"));
		}
		HX_STACK_LINE(721)
		Float _g;		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(721)
		...
		struct _Function_1_1{
			inline static bool Block( ::nape::geom::AABB &aabb){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/space/Space.hx",721,0x769bc808)
				{
					HX_STACK_LINE(721)
					Float _g1;		HX_STACK_VAR(_g1,"_g1");
					HX_STACK_LINE(721)
		...
		if (((  ((!(((_g == (int)0))))) ? bool(_Function_1_1::Block(aabb)) : bool(true) ))){
			HX_STACK_LINE(721)
			HX_STACK_DO_THROW(HX_CSTRING("Error: Cannot evaluate objects in degenerate AABB :/"));
		}
		HX_STACK_LINE(723)
	...
	HX_STACK_ARG(output,"output")
{
		...
		if (((position == null()))){
			HX_STACK_LINE(751)
			HX_STACK_DO_THROW(HX_CSTRING("Error: Cannot evaluate shapes at null circle :)"));
		}
		HX_STACK_LINE(752)
		if (((radius != radius))){
			HX_STACK_LINE(752)
			HX_STACK_DO_THROW(HX_CSTRING("Error: Circle radius cannot be NaN"));
		}
		HX_STACK_LINE(753)
		if (((radius <= (int)0))){
			HX_STACK_LINE(753)
			HX_STACK_DO_THROW(HX_CSTRING("Error: Circle radius must be strictly positive"));
		}
		HX_STACK_LINE(755)
	...
	HX_STACK_ARG(output,"output")
{
		...
		if (((position == null()))){
			HX_STACK_LINE(798)
			HX_STACK_DO_THROW(HX_CSTRING("Error: Cannot evaluate objects at null circle :)"));
		}
		HX_STACK_LINE(799)
		if (((radius != radius))){
			HX_STACK_LINE(799)
	...
	HX_STACK_ARG(output,"output")
{
		...
		if (((shape == null()))){
			HX_STACK_LINE(840)
			HX_STACK_DO_THROW(HX_CSTRING("Error: Cannot evaluate shapes in a null shapes :)"));
		}
		HX_STACK_LINE(841)
		if (((((  (((shape->zpp_inner->body != null()))) ? ::nape::phys::Body(shape->zpp_inner->body->outer) : ::nape::phys::Body(null()) )) == null()))){
			HX_STACK_LINE(841)
			HX_STACK_DO_THROW(HX_CSTRING("Error: Query shape needs to be inside a Body to be well defined :)"));
		}
		HX_STACK_LINE(842)
		if (((shape->zpp_inner->type == ::zpp_nape::util::ZPP_Flags_obj::id_ShapeType_POLYGON))){
			...
			if (((res != _g1))){
				HX_STACK_LINE(844)
				::String _g2 = res->toString();		HX_STACK_VAR(_g2,"_g2");
				HX_STACK_LINE(844)
				HX_STACK_DO_THROW((HX_CSTRING("Error: Polygon query shape is invalid : ") + _g2));
			}
		}
		HX_STACK_LINE(847)
	...
	HX_STACK_ARG(output,"output")
{
		...
		if (((shape == null()))){
			HX_STACK_LINE(872)
			HX_STACK_DO_THROW(HX_CSTRING("Error: Cannot evaluate bodies in a null shapes :)"));
		}
		HX_STACK_LINE(873)
		if (((((  (((shape->zpp_inner->body != null()))) ? ::nape::phys::Body(shape->zpp_inner->body->outer) : ::nape::phys::Body(null()) )) == null()))){
			HX_STACK_LINE(873)
...
::nape::shape::ShapeList Space_obj::shapesInBody( ::nape::phys::Body body,::nape::dynamics::InteractionFilter filter,::nape::shape::ShapeList output){
	...
	if (((body == null()))){
		HX_STACK_LINE(900)
		HX_STACK_DO_THROW(HX_CSTRING("Error: Cannot evaluate shapes in null body"));
	}
	HX_STACK_LINE(902)
	...
	HX_STACK_ARG(filter,"filter")
{
		...
		if (((shape == null()))){
			HX_STACK_LINE(959)
			HX_STACK_DO_THROW(HX_CSTRING("Error: Cannot cast null shape :)"));
		}
		HX_STACK_LINE(962)
		if (((((  (((shape->zpp_inner->body != null()))) ? ::nape::phys::Body(shape->zpp_inner->body->outer) : ::nape::phys::Body(null()) )) == null()))){
			HX_STACK_LINE(962)
			HX_STACK_DO_THROW(HX_CSTRING("Error: Shape must belong to a body to be cast."));
		}
		HX_STACK_LINE(965)
		if (((bool((deltaTime < (int)0)) || bool((deltaTime != deltaTime))))){
			HX_STACK_LINE(965)
			HX_STACK_DO_THROW(HX_CSTRING("Error: deltaTime must be positive"));
		}
		HX_STACK_LINE(967)
	...
	HX_STACK_ARG(filter,"filter")
{
		...
		if (((ray == null()))){
			HX_STACK_LINE(1025)
			HX_STACK_DO_THROW(HX_CSTRING("Error: Cannot cast null ray :)"));
		}
		HX_STACK_LINE(1027)
