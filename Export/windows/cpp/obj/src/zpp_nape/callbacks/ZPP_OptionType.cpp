...
Void ZPP_OptionType_obj::append( ::zpp_nape::util::ZNPList_ZPP_CbType list,Dynamic val){
{
		...
		if (((val == null()))){
			HX_STACK_LINE(315)
			HX_STACK_DO_THROW(HX_CSTRING("Error: Cannot append null, only CbType and CbType list values"));
		}
		HX_STACK_LINE(318)
					...
					HX_STACK_LINE(334)
					{
						...
						while((true)){
							...
							if ((!(::Std_obj::is(cb,hx::ClassOf< ::nape::callbacks::CbType >())))){
								HX_STACK_LINE(337)
								HX_STACK_DO_THROW(HX_CSTRING("Error: Cannot append non-CbType or CbType list value"));
							}
							HX_STACK_LINE(340)
