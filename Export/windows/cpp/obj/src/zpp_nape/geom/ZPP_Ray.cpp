...
Void ZPP_Ray_obj::validate_dir( ){
{
		...
		if ((this->zip_dir)){
			...
			if (((((this->dirx * this->dirx) + (this->diry * this->diry)) < ::nape::Config_obj::epsilon))){
				HX_STACK_LINE(295)
				HX_STACK_DO_THROW(HX_CSTRING("Error: Ray::direction is degenerate"));
			}
			HX_STACK_LINE(298)
			{
				HX_STACK_LINE(299)
...
Void ZPP_Ray_obj::circlesect2( ::zpp_nape::shape::ZPP_Circle c,bool inner,::nape::geom::RayResultList list){
{
		...
		if (((det == (int)0))){
			...
			if (((bool((bool(((bool(!(inner)) || bool((C > (int)0))))) && bool((t > (int)0)))) && bool((t <= this->maxdist))))){
				...
				HX_STACK_LINE(854)
				{
					...
					HX_STACK_LINE(867)
					{
						...
						HX_STACK_LINE(867)
						{
							...
							HX_STACK_LINE(867)
							{
								...
								if (((::zpp_nape::util::ZNPNode_RayResult_obj::zpp_pool == null()))){
									HX_STACK_LINE(867)
									::zpp_nape::util::ZNPNode_RayResult _g11 = ::zpp_nape::util::ZNPNode_RayResult_obj::__new();		HX_STACK_VAR(_g11,"_g11");
									HX_STACK_LINE(867)
									ret = _g11;
								}
								else{
						...
						HX_STACK_LINE(867)
						bool _g12 = _this->modified = true;		HX_STACK_VAR(_g12,"_g12");
						HX_STACK_LINE(867)
						_this->pushmod = _g12;
						HX_STACK_LINE(867)
						(_this->length)++;
			...
			HX_STACK_LINE(872)
			Float _g13 = ::Math_obj::sqrt(det);		HX_STACK_VAR(_g13,"_g13");
			HX_STACK_LINE(872)
			det = _g13;
			HX_STACK_LINE(873)
			A = (Float((int)1) / Float((((int)2 * A))));
			...
			if (((bool((t0 > (int)0)) && bool((t0 <= this->maxdist))))){
				...
				HX_STACK_LINE(954)
				{
					...
					if (((ret->zpp_inner == null()))){
						...
						HX_STACK_LINE(954)
						if ((!(((  (((_g18 == nx))) ? bool(_Function_5_1::Block(ret,ny)) : bool(false) ))))){
							HX_STACK_LINE(954)
							{
								HX_STACK_LINE(954)
								ret->zpp_inner->x = nx;
				...
				HX_STACK_LINE(954)
				::nape::geom::RayResult res = ::zpp_nape::geom::ZPP_ConvexRayResult_obj::getRay(_g20,t0,false,c->outer);		HX_STACK_VAR(res,"res");
				HX_STACK_LINE(955)
				{
					HX_STACK_LINE(956)
					::zpp_nape::util::ZNPNode_RayResult pre = null();		HX_STACK_VAR(pre,"pre");
						...
						while((true)){
							...
							HX_STACK_LINE(961)
							{
								...
								HX_STACK_LINE(962)
								{
									...
									HX_STACK_LINE(962)
									_g21 = res->zpp_inner->toiDistance;
								}
								HX_STACK_LINE(962)
								Float _g22;		HX_STACK_VAR(_g22,"_g22");
								HX_STACK_LINE(962)
					...
					HX_STACK_LINE(968)
					{
						...
						HX_STACK_LINE(968)
						{
							...
							HX_STACK_LINE(968)
							{
								...
								if (((::zpp_nape::util::ZNPNode_RayResult_obj::zpp_pool == null()))){
									HX_STACK_LINE(968)
									::zpp_nape::util::ZNPNode_RayResult _g23 = ::zpp_nape::util::ZNPNode_RayResult_obj::__new();		HX_STACK_VAR(_g23,"_g23");
									HX_STACK_LINE(968)
									ret = _g23;
								}
								else{
						...
						HX_STACK_LINE(968)
						bool _g24 = _this->modified = true;		HX_STACK_VAR(_g24,"_g24");
						HX_STACK_LINE(968)
						_this->pushmod = _g24;
						HX_STACK_LINE(968)
						(_this->length)++;
			...
			if (((bool((bool((t1 > (int)0)) && bool((t1 <= this->maxdist)))) && bool(inner)))){
				...
				HX_STACK_LINE(1020)
				{
					...
					Float d = ((nx * nx) + (ny * ny));		HX_STACK_VAR(d,"d");
					HX_STACK_LINE(1030)
					Float _g25 = ::Math_obj::sqrt(d);		HX_STACK_VAR(_g25,"_g25");
					HX_STACK_LINE(1030)
					Float imag = (Float(1.0) / Float(_g25));		HX_STACK_VAR(imag,"imag");
					HX_STACK_LINE(1031)
					{
						HX_STACK_LINE(1032)
						Float t = imag;		HX_STACK_VAR(t,"t");
				...
				HX_STACK_LINE(1049)
				{
					...
					if (((ret->zpp_inner == null()))){
						...
						HX_STACK_LINE(1049)
						if ((!(((  (((_g29 == nx))) ? bool(_Function_5_1::Block(ret,ny)) : bool(false) ))))){
							HX_STACK_LINE(1049)
							{
								HX_STACK_LINE(1049)
								ret->zpp_inner->x = nx;
				...
				HX_STACK_LINE(1049)
				::nape::geom::RayResult res = ::zpp_nape::geom::ZPP_ConvexRayResult_obj::getRay(_g31,t1,true,c->outer);		HX_STACK_VAR(res,"res");
				HX_STACK_LINE(1050)
				{
					HX_STACK_LINE(1051)
					::zpp_nape::util::ZNPNode_RayResult pre = null();		HX_STACK_VAR(pre,"pre");
						...
						while((true)){
							...
							HX_STACK_LINE(1056)
							{
								...
								HX_STACK_LINE(1057)
								{
									...
									HX_STACK_LINE(1057)
									_g32 = res->zpp_inner->toiDistance;
								}
								HX_STACK_LINE(1057)
					...
					HX_STACK_LINE(1063)
					{
						...
						HX_STACK_LINE(1063)
						{
							...
							HX_STACK_LINE(1063)
							{
								...
								if (((::zpp_nape::util::ZNPNode_RayResult_obj::zpp_pool == null()))){
									HX_STACK_LINE(1063)
									::zpp_nape::util::ZNPNode_RayResult _g34 = ::zpp_nape::util::ZNPNode_RayResult_obj::__new();		HX_STACK_VAR(_g34,"_g34");
									HX_STACK_LINE(1063)
									ret = _g34;
								}
								else{
						...
						HX_STACK_LINE(1063)
						bool _g35 = _this->modified = true;		HX_STACK_VAR(_g35,"_g35");
						HX_STACK_LINE(1063)
						_this->pushmod = _g35;
						HX_STACK_LINE(1063)
						(_this->length)++;
				...
				HX_STACK_LINE(1326)
				{
					...
					HX_STACK_LINE(1326)
					{
						...
						HX_STACK_LINE(1326)
						{
							...
							if (((::zpp_nape::util::ZNPNode_RayResult_obj::zpp_pool == null()))){
								HX_STACK_LINE(1326)
								::zpp_nape::util::ZNPNode_RayResult _g8 = ::zpp_nape::util::ZNPNode_RayResult_obj::__new();		HX_STACK_VAR(_g8,"_g8");
								HX_STACK_LINE(1326)
								ret1 = _g8;
							}
							else{
		...
		if (((bool((edgemax != null())) && bool((edge != edgemax))))){
			...
			HX_STACK_LINE(1357)
			{
				...
				if (((ret->zpp_inner == null()))){
					...
					HX_STACK_LINE(1357)
					if ((!(((  (((_g13 == nx))) ? bool(_Function_4_1::Block(ret,ny)) : bool(false) ))))){
						HX_STACK_LINE(1357)
						{
							HX_STACK_LINE(1357)
							ret->zpp_inner->x = nx;
			...
			HX_STACK_LINE(1357)
			::nape::geom::RayResult ret = ::zpp_nape::geom::ZPP_ConvexRayResult_obj::getRay(_g15,max,inner1,p->outer);		HX_STACK_VAR(ret,"ret");
			HX_STACK_LINE(1358)
			{
				HX_STACK_LINE(1359)
				::zpp_nape::util::ZNPNode_RayResult pre = null();		HX_STACK_VAR(pre,"pre");
					...
					while((true)){
						...
						HX_STACK_LINE(1364)
						{
							...
							HX_STACK_LINE(1365)
							{
								...
								HX_STACK_LINE(1365)
								_g16 = ret->zpp_inner->toiDistance;
							}
							HX_STACK_LINE(1365)
				...
				HX_STACK_LINE(1371)
				{
					...
					HX_STACK_LINE(1371)
					{
						...
						HX_STACK_LINE(1371)
						{
							...
							if (((::zpp_nape::util::ZNPNode_RayResult_obj::zpp_pool == null()))){
								HX_STACK_LINE(1371)
								::zpp_nape::util::ZNPNode_RayResult _g18 = ::zpp_nape::util::ZNPNode_RayResult_obj::__new();		HX_STACK_VAR(_g18,"_g18");
								HX_STACK_LINE(1371)
								ret1 = _g18;
							}
							else{
					...
					HX_STACK_LINE(1371)
					bool _g19 = _this->modified = true;		HX_STACK_VAR(_g19,"_g19");
					HX_STACK_LINE(1371)
					_this->pushmod = _g19;
					HX_STACK_LINE(1371)
					(_this->length)++;
