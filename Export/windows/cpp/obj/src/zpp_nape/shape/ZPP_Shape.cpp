...
{
		HX_STACK_FRAME("zpp_nape.shape.ZPP_Shape","__immutable_midstep",0x993ac337,"zpp_nape.shape.ZPP_Shape.__immutable_midstep","zpp_nape/shape/Shape.hx",481,0xb83747cd)
		HX_STACK_THIS(this)
