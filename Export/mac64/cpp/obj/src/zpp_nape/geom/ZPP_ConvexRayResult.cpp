...
{
		HX_STACK_FRAME("zpp_nape.geom.ZPP_ConvexRayResult","disposed",0x23c01849,"zpp_nape.geom.ZPP_ConvexRayResult.disposed","zpp_nape/geom/ConvexRayResult.hx",236,0x535a39cf)
		HX_STACK_THIS(this)
		HX_STACK_LINE(236)
		if (((this->next != null()))){
			HX_STACK_LINE(236)
