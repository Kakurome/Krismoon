...
{
		HX_STACK_FRAME("zpp_nape.constraint.ZPP_Constraint","immutable_midstep",0x734194fb,"zpp_nape.constraint.ZPP_Constraint.immutable_midstep","zpp_nape/constraint/Constraint.hx",210,0xf29441f1)
		HX_STACK_THIS(this)
		HX_STACK_ARG(name,"name")
		HX_STACK_LINE(210)
		if (((bool((this->space != null())) && bool(this->space->midstep)))){
			HX_STACK_LINE(210)
			HX_STACK_DO_THROW(((HX_CSTRING("Error: Constraint::") + name) + HX_CSTRING(" cannot be set during space step()")));
		}
	}
return null();
}
