...
::nape::geom::RayResult ZPP_SweepPhase_obj::rayCast( ::zpp_nape::geom::ZPP_Ray ray,bool inner,::zpp_nape::dynamics::ZPP_InteractionFilter filter){
				...
				if (((bool((t >= (int)0)) && bool((t < mint))))){
					...
					if (((result != null()))){
						...
						HX_STACK_LINE(671)
						{
							...
							HX_STACK_LINE(671)
							_g = result->zpp_inner->toiDistance;
						}
						HX_STACK_LINE(671)
						mint = _g;
						HX_STACK_LINE(672)
					...
					if (((bool((t >= (int)0)) && bool((t < mint))))){
						...
						if (((result != null()))){
							...
							HX_STACK_LINE(696)
							{
								...
								HX_STACK_LINE(696)
								_g1 = result->zpp_inner->toiDistance;
							}
							HX_STACK_LINE(696)
							mint = _g1;
							HX_STACK_LINE(697)
					...
					if (((bool((t >= (int)0)) && bool((t < mint))))){
						...
						if (((result != null()))){
							...
							HX_STACK_LINE(715)
							{
								...
								HX_STACK_LINE(715)
								_g2 = result->zpp_inner->toiDistance;
							}
							HX_STACK_LINE(715)
							mint = _g2;
							HX_STACK_LINE(716)
	...
	HX_STACK_LINE(726)
	{
		...
		HX_STACK_LINE(736)
		{
			...
			HX_STACK_LINE(736)
			::nape::geom::Vec2 _g3 = o->wrap_max = null();		HX_STACK_VAR(_g3,"_g3");
			HX_STACK_LINE(736)
			o->wrap_min = _g3;
			HX_STACK_LINE(736)
			o->_invalidate = null();
