...
{
		HX_STACK_FRAME("zpp_nape.callbacks.ZPP_ConstraintListener","immutable_options",0x279bd5ea,"zpp_nape.callbacks.ZPP_ConstraintListener.immutable_options","zpp_nape/callbacks/Listener.hx",276,0x87b155a7)
		HX_STACK_THIS(this)
		HX_STACK_LINE(276)
...
Void ZPP_ConstraintListener_obj::swapEvent( int newev){
{
		...
		if (((bool((bool((newev != ::zpp_nape::util::ZPP_Flags_obj::id_CbEvent_WAKE)) && bool((newev != ::zpp_nape::util::ZPP_Flags_obj::id_CbEvent_SLEEP)))) && bool((newev != ::zpp_nape::util::ZPP_Flags_obj::id_CbEvent_BREAK))))){
			HX_STACK_LINE(329)
			HX_STACK_DO_THROW(HX_CSTRING("Error: ConstraintListener event must be either WAKE or SLEEP only"));
		}
		HX_STACK_LINE(332)
		this->removedFromSpace();
		HX_STACK_LINE(333)
