...
{
HX_STACK_FRAME("nape.phys.BodyType","new",0x00b540a4,"nape.phys.BodyType.new","nape/phys/BodyType.hx",183,0x8b4ddeec)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(183)
	if ((!(::zpp_nape::util::ZPP_Flags_obj::internal))){
		HX_STACK_LINE(183)
		HX_STACK_DO_THROW(HX_CSTRING("Error: Cannot instantiate BodyType derp!"));
	}
}
;
	return null();
