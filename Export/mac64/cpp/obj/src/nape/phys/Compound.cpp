...
::nape::space::Space Compound_obj::set_space( ::nape::space::Space space){
	...
	HX_STACK_LINE(270)
	{
		...
		if (((this->zpp_inner->compound != null()))){
			HX_STACK_LINE(272)
			HX_STACK_DO_THROW(HX_CSTRING("Error: Cannot set the space of an inner Compound, only the root Compound space can be set"));
		}
		HX_STACK_LINE(274)
...
Void Compound_obj::visitBodies( Dynamic lambda){
{
		...
		if (((lambda == null()))){
			HX_STACK_LINE(356)
			HX_STACK_DO_THROW(HX_CSTRING("Error: lambda cannot be null for Compound::visitBodies"));
		}
		HX_STACK_LINE(358)
		{
			HX_STACK_LINE(358)
...
Void Compound_obj::visitConstraints( Dynamic lambda){
{
		...
		if (((lambda == null()))){
			HX_STACK_LINE(370)
			HX_STACK_DO_THROW(HX_CSTRING("Error: lambda cannot be null for Compound::visitConstraints"));
		}
		HX_STACK_LINE(372)
		{
			HX_STACK_LINE(372)
...
{
		HX_STACK_FRAME("nape.phys.Compound","visitCompounds",0x6b13718a,"nape.phys.Compound.visitCompounds","nape/phys/Compound.hx",382,0x15c2ad5d)
		HX_STACK_THIS(this)
		HX_STACK_ARG(lambda,"lambda")
		HX_STACK_LINE(384)
		if (((lambda == null()))){
	...
	HX_STACK_ARG(weak,"weak")
{
		...
		if (((total->__get((int)0) == 0.0))){
			HX_STACK_LINE(411)
			HX_STACK_DO_THROW(HX_CSTRING("Error: COM of an empty Compound is undefined silly"));
		}
		HX_STACK_LINE(413)
...
::nape::phys::Compound Compound_obj::translate( ::nape::geom::Vec2 translation){
	...
	if (((translation1->__get((int)0).StaticCast< ::nape::geom::Vec2 >() == null()))){
		HX_STACK_LINE(433)
		HX_STACK_DO_THROW(HX_CSTRING("Error: Cannot translate by null Vec2"));
	}
	HX_STACK_LINE(435)
