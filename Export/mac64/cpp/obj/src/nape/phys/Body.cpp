	...
	HX_STACK_LINE(518)
	{
		...
		HX_STACK_LINE(518)
		{
			...
			if (((::zpp_nape::phys::ZPP_Body_obj::types->__get(this->zpp_inner->type).StaticCast< ::nape::phys::BodyType >() != type1))){
				...
				if (((type1 == null()))){
					HX_STACK_LINE(518)
					HX_STACK_DO_THROW(HX_CSTRING("Error: Cannot use null BodyType"));
				}
				HX_STACK_LINE(518)
...
::nape::phys::Body Body_obj::integrate( Float deltaTime){
	...
	if (((deltaTime != deltaTime))){
		HX_STACK_LINE(297)
		HX_STACK_DO_THROW(HX_CSTRING("Cannot integrate by NaN time"));
	}
	HX_STACK_LINE(299)
...
::nape::phys::Body Body_obj::copy( ){
	HX_STACK_FRAME("nape.phys.Body","copy",0x5d0e080b,"nape.phys.Body.copy","nape/phys/Body.hx",543,0xcb2bb586)
	HX_STACK_THIS(this)
	HX_STACK_LINE(545)
	if ((this->zpp_inner->world)){
		HX_STACK_LINE(545)
		HX_STACK_DO_THROW(HX_CSTRING("Error: Space::world cannot be copied"));
	}
	HX_STACK_LINE(547)
...
::nape::geom::Vec2 Body_obj::set_position( ::nape::geom::Vec2 position){
	...
	HX_STACK_LINE(570)
	{
		...
		if (((position == null()))){
			HX_STACK_LINE(577)
			HX_STACK_DO_THROW(HX_CSTRING("Error: Body::position cannot be null"));
		}
		HX_STACK_LINE(579)
		{
			HX_STACK_LINE(579)
...
::nape::geom::Vec2 Body_obj::set_velocity( ::nape::geom::Vec2 velocity){
	...
	HX_STACK_LINE(599)
	{
		...
		if (((velocity == null()))){
			HX_STACK_LINE(606)
			HX_STACK_DO_THROW(HX_CSTRING("Error: Body::velocity cannot be null"));
		}
		HX_STACK_LINE(608)
		{
			HX_STACK_LINE(608)
...
::nape::phys::Body Body_obj::setVelocityFromTarget( ::nape::geom::Vec2 targetPosition,Float targetRotation,Float deltaTime){
	...
	if (((targetPosition == null()))){
		HX_STACK_LINE(636)
		HX_STACK_DO_THROW(HX_CSTRING("Cannot set velocity for null target position"));
	}
	HX_STACK_LINE(637)
	if (((deltaTime == (int)0))){
		HX_STACK_LINE(637)
		HX_STACK_DO_THROW(HX_CSTRING("deltaTime cannot be 0 for setVelocityFromTarget"));
	}
	HX_STACK_LINE(639)
		...
		HX_STACK_LINE(641)
		{
			...
			if (((this->zpp_inner->angvel != angularVel))){
				...
				if (((angularVel != angularVel))){
					HX_STACK_LINE(641)
					HX_STACK_DO_THROW(HX_CSTRING("Error: Body::angularVel cannot be NaN"));
				}
				HX_STACK_LINE(641)
				if (((this->zpp_inner->type == ::zpp_nape::util::ZPP_Flags_obj::id_BodyType_STATIC))){
					HX_STACK_LINE(641)
					HX_STACK_DO_THROW(HX_CSTRING("Error: A static object cannot be given a velocity"));
				}
				HX_STACK_LINE(641)
...
::nape::geom::Vec2 Body_obj::set_kinematicVel( ::nape::geom::Vec2 kinematicVel){
	...
	HX_STACK_LINE(674)
	{
		...
		if (((kinematicVel == null()))){
			HX_STACK_LINE(681)
			HX_STACK_DO_THROW(HX_CSTRING("Error: Body::kinematicVel cannot be null"));
		}
		HX_STACK_LINE(683)
		{
			HX_STACK_LINE(683)
...
::nape::geom::Vec2 Body_obj::set_surfaceVel( ::nape::geom::Vec2 surfaceVel){
	...
	HX_STACK_LINE(706)
	{
		...
		if (((surfaceVel == null()))){
			HX_STACK_LINE(713)
			HX_STACK_DO_THROW(HX_CSTRING("Error: Body::surfaceVel cannot be null"));
		}
		HX_STACK_LINE(715)
		{
			HX_STACK_LINE(715)
...
::nape::geom::Vec2 Body_obj::set_force( ::nape::geom::Vec2 force){
	...
	HX_STACK_LINE(735)
	{
		...
		if (((force == null()))){
			HX_STACK_LINE(742)
			HX_STACK_DO_THROW(HX_CSTRING("Error: Body::force cannot be null"));
		}
		HX_STACK_LINE(744)
		{
			HX_STACK_LINE(744)
...
Float Body_obj::set_rotation( Float rotation){
	...
	HX_STACK_LINE(778)
	{
		...
		if (((bool((this->zpp_inner->type == ::zpp_nape::util::ZPP_Flags_obj::id_BodyType_STATIC)) && bool((this->zpp_inner->space != null()))))){
			HX_STACK_LINE(784)
			HX_STACK_DO_THROW(HX_CSTRING("Error: Static objects cannot be rotated once inside a Space"));
		}
		HX_STACK_LINE(786)
		if (((this->zpp_inner->rot != rotation))){
			...
			if (((rotation != rotation))){
				HX_STACK_LINE(788)
				HX_STACK_DO_THROW(HX_CSTRING("Error: Body::rotation cannot be NaN"));
			}
			HX_STACK_LINE(790)
	...
	HX_STACK_LINE(845)
	{
		...
		if (((this->zpp_inner->kinangvel != kinAngVel))){
			...
			if (((kinAngVel != kinAngVel))){
				HX_STACK_LINE(851)
				HX_STACK_DO_THROW(HX_CSTRING("Error: Body::kinAngVel cannot be NaN"));
			}
			HX_STACK_LINE(853)
...
Float Body_obj::set_torque( Float torque){
	...
	HX_STACK_LINE(874)
	{
		...
		if ((!(((this->zpp_inner->type == ::zpp_nape::util::ZPP_Flags_obj::id_BodyType_DYNAMIC))))){
			HX_STACK_LINE(879)
			HX_STACK_DO_THROW(HX_CSTRING("Error: Non-dynamic body cannot have torque applied."));
		}
		HX_STACK_LINE(882)
		if (((torque != torque))){
			HX_STACK_LINE(882)
			HX_STACK_DO_THROW(HX_CSTRING("Error: Body::torque cannot be NaN"));
		}
		HX_STACK_LINE(884)
...
::nape::geom::AABB Body_obj::get_bounds( ){
	HX_STACK_FRAME("nape.phys.Body","get_bounds",0xe6252714,"nape.phys.Body.get_bounds","nape/phys/Body.hx",902,0xcb2bb586)
	HX_STACK_THIS(this)
	HX_STACK_LINE(904)
	if ((this->zpp_inner->world)){
		HX_STACK_LINE(904)
		HX_STACK_DO_THROW(HX_CSTRING("Error: Space::world has no bounds"));
	}
	HX_STACK_LINE(906)
...
::nape::phys::MassMode Body_obj::set_massMode( ::nape::phys::MassMode massMode){
	...
	HX_STACK_LINE(971)
	{
		...
		if (((massMode == null()))){
			HX_STACK_LINE(977)
			HX_STACK_DO_THROW(HX_CSTRING("Error: cannot use null massMode"));
		}
		HX_STACK_LINE(979)
		::nape::phys::MassMode _g1;		HX_STACK_VAR(_g1,"_g1");
		HX_STACK_LINE(979)
...
Float Body_obj::get_mass( ){
	...
	if ((this->zpp_inner->world)){
		HX_STACK_LINE(1013)
		HX_STACK_DO_THROW(HX_CSTRING("Error: Space::world has no mass"));
	}
	HX_STACK_LINE(1015)
	this->zpp_inner->validate_mass();
	HX_STACK_LINE(1017)
	if (((bool((this->zpp_inner->massMode == ::zpp_nape::util::ZPP_Flags_obj::id_MassMode_DEFAULT)) && bool((this->zpp_inner->shapes->head == null()))))){
		HX_STACK_LINE(1017)
		HX_STACK_DO_THROW(HX_CSTRING("Error: Given current mass mode, Body::mass only makes sense if it contains shapes"));
	}
	HX_STACK_LINE(1019)
...
Float Body_obj::set_mass( Float mass){
	...
	HX_STACK_LINE(1022)
	{
		...
		if (((mass != mass))){
			HX_STACK_LINE(1028)
			HX_STACK_DO_THROW(HX_CSTRING("Error: Mass cannot be NaN"));
		}
		HX_STACK_LINE(1029)
		if (((mass <= (int)0))){
			HX_STACK_LINE(1029)
			HX_STACK_DO_THROW(HX_CSTRING("Error: Mass must be strictly positive"));
		}
		HX_STACK_LINE(1030)
		if (((mass >= ::Math_obj::POSITIVE_INFINITY))){
			HX_STACK_LINE(1030)
			HX_STACK_DO_THROW(HX_CSTRING("Error: Mass cannot be infinite, use allowMovement = false instead"));
		}
		HX_STACK_LINE(1032)
...
::nape::phys::GravMassMode Body_obj::set_gravMassMode( ::nape::phys::GravMassMode gravMassMode){
	...
	HX_STACK_LINE(1051)
	{
		...
		if (((gravMassMode == null()))){
			HX_STACK_LINE(1057)
			HX_STACK_DO_THROW(HX_CSTRING("Error: Cannot use null gravMassMode"));
		}
		HX_STACK_LINE(1059)
		::nape::phys::GravMassMode _g1;		HX_STACK_VAR(_g1,"_g1");
		HX_STACK_LINE(1059)
...
Float Body_obj::get_gravMass( ){
	...
	if ((this->zpp_inner->world)){
		HX_STACK_LINE(1075)
		HX_STACK_DO_THROW(HX_CSTRING("Error: Space::world has no gravMass"));
	}
	HX_STACK_LINE(1077)
	...
	if (((this->zpp_inner->shapes->head == null()))){
		...
		if (((bool((this->zpp_inner->massMode == ::zpp_nape::util::ZPP_Flags_obj::id_MassMode_DEFAULT)) && bool((this->zpp_inner->gravMassMode != ::zpp_nape::util::ZPP_Flags_obj::id_GravMassMode_FIXED))))){
			HX_STACK_LINE(1080)
			HX_STACK_DO_THROW(HX_CSTRING("Error: Given current mass/gravMass modes; Body::gravMass only makes sense if it contains Shapes"));
		}
	}
	HX_STACK_LINE(1083)
...
Float Body_obj::set_gravMass( Float gravMass){
	...
	HX_STACK_LINE(1086)
	{
		...
		if (((gravMass != gravMass))){
			HX_STACK_LINE(1092)
			HX_STACK_DO_THROW(HX_CSTRING("Error: gravMass cannot be NaN"));
		}
		HX_STACK_LINE(1094)
...
Float Body_obj::get_gravMassScale( ){
	...
	if (((this->zpp_inner->shapes->head == null()))){
		...
		if (((bool((this->zpp_inner->massMode == ::zpp_nape::util::ZPP_Flags_obj::id_MassMode_DEFAULT)) && bool((this->zpp_inner->gravMassMode != ::zpp_nape::util::ZPP_Flags_obj::id_GravMassMode_SCALED))))){
			HX_STACK_LINE(1114)
			HX_STACK_DO_THROW(HX_CSTRING("Error: Given current mass/gravMass modes; Body::gravMassScale only makes sense if it contains Shapes"));
		}
	}
	HX_STACK_LINE(1117)
...
Float Body_obj::set_gravMassScale( Float gravMassScale){
	...
	HX_STACK_LINE(1120)
	{
		...
		if (((gravMassScale != gravMassScale))){
			HX_STACK_LINE(1126)
			HX_STACK_DO_THROW(HX_CSTRING("Error: gravMassScale cannot be NaN"));
		}
		HX_STACK_LINE(1128)
...
::nape::phys::InertiaMode Body_obj::set_inertiaMode( ::nape::phys::InertiaMode inertiaMode){
	...
	HX_STACK_LINE(1147)
	{
		...
		if (((inertiaMode == null()))){
			HX_STACK_LINE(1153)
			HX_STACK_DO_THROW(HX_CSTRING("Error: Cannot use null InertiaMode"));
		}
		HX_STACK_LINE(1155)
		::nape::phys::InertiaMode _g1;		HX_STACK_VAR(_g1,"_g1");
		HX_STACK_LINE(1155)
...
Float Body_obj::get_inertia( ){
	...
	if ((this->zpp_inner->world)){
		HX_STACK_LINE(1182)
		HX_STACK_DO_THROW(HX_CSTRING("Error: Space::world has no inertia"));
	}
	HX_STACK_LINE(1184)
	this->zpp_inner->validate_inertia();
	struct _Function_1_1{
		inline static bool Block( hx::ObjectPtr< ::nape::phys::Body_obj > __this){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/phys/Body.hx",1186,0xcb2bb586)
			{
				HX_STACK_LINE(1186)
	...
	HX_STACK_LINE(1186)
	if (((  (((this->zpp_inner->inertiaMode == ::zpp_nape::util::ZPP_Flags_obj::id_InertiaMode_DEFAULT))) ? bool(_Function_1_1::Block(this)) : bool(false) ))){
		HX_STACK_LINE(1186)
		HX_STACK_DO_THROW(HX_CSTRING("Error: Given current inertia mode flag, Body::inertia only makes sense if Body contains Shapes"));
	}
	HX_STACK_LINE(1188)
...
Float Body_obj::set_inertia( Float inertia){
	...
	HX_STACK_LINE(1191)
	{
		...
		if (((inertia != inertia))){
			HX_STACK_LINE(1197)
			HX_STACK_DO_THROW(HX_CSTRING("Error: Inertia cannot be NaN"));
		}
		HX_STACK_LINE(1198)
		if (((inertia <= (int)0))){
			HX_STACK_LINE(1198)
			HX_STACK_DO_THROW(HX_CSTRING("Error: Inertia must be strictly positive"));
		}
		HX_STACK_LINE(1199)
		if (((inertia >= ::Math_obj::POSITIVE_INFINITY))){
			HX_STACK_LINE(1199)
			HX_STACK_DO_THROW(HX_CSTRING("Error: Inertia cannot be infinite, use allowRotation = false instead"));
		}
		HX_STACK_LINE(1201)
	...
	struct _Function_1_1{
		inline static bool Block( hx::ObjectPtr< ::nape::phys::Body_obj > __this){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/phys/Body.hx",1205,0xcb2bb586)
			{
				HX_STACK_LINE(1205)
				::nape::shape::ShapeList _this = __this->zpp_inner->wrap_shapes;		HX_STACK_VAR(_this,"_this");
				HX_STACK_LINE(1205)
...
Float Body_obj::crushFactor( ){
	...
	if (((((  (((this->zpp_inner->space == null()))) ? ::nape::space::Space(null()) : ::nape::space::Space(this->zpp_inner->space->outer) )) == null()))){
		HX_STACK_LINE(1266)
		HX_STACK_DO_THROW(HX_CSTRING("Error: Makes no sense to see how much an object not taking part in a simulation is being crushed"));
	}
	HX_STACK_LINE(1268)
	...
	HX_STACK_ARG(weak,"weak")
{
		...
		if (((point == null()))){
			HX_STACK_LINE(1308)
			HX_STACK_DO_THROW(HX_CSTRING("Error: Cannot transform null Vec2"));
		}
		HX_STACK_LINE(1310)
		{
			HX_STACK_LINE(1310)
	...
	HX_STACK_ARG(sleepable,"sleepable")
{
		...
		if (((impulse == null()))){
			HX_STACK_LINE(1494)
			HX_STACK_DO_THROW(HX_CSTRING("Error: Cannot apply null impulse to Body"));
		}
		struct _Function_1_1{
			inline static bool Block( hx::ObjectPtr< ::nape::phys::Body_obj > __this){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/phys/Body.hx",1496,0xcb2bb586)
				{
					HX_STACK_LINE(1496)
		...
		HX_STACK_LINE(1496)
		if (((  ((sleepable)) ? bool(_Function_1_1::Block(this)) : bool(false) ))){
			HX_STACK_LINE(1497)
	...
	HX_STACK_ARG(sleepable,"sleepable")
{
		...
		struct _Function_1_1{
			inline static bool Block( hx::ObjectPtr< ::nape::phys::Body_obj > __this){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/phys/Body.hx",1592,0xcb2bb586)
				{
					HX_STACK_LINE(1592)
					if (((__this->zpp_inner->space == null()))){
						HX_STACK_LINE(1592)
...
::nape::phys::Body Body_obj::translateShapes( ::nape::geom::Vec2 translation){
	...
	if (((translation == null()))){
		HX_STACK_LINE(1625)
		HX_STACK_DO_THROW(HX_CSTRING("Error: Cannot displace by null Vec2"));
	}
	HX_STACK_LINE(1627)
...
::nape::phys::Body Body_obj::align( ){
	...
	if (((this->zpp_inner->shapes->head == null()))){
		HX_STACK_LINE(1756)
		HX_STACK_DO_THROW(HX_CSTRING("Error: Cannot align empty Body"));
	}
	HX_STACK_LINE(1758)
...
::nape::phys::Body Body_obj::rotate( ::nape::geom::Vec2 centre,Float angle){
	...
	if (((centre == null()))){
		HX_STACK_LINE(1800)
		HX_STACK_DO_THROW(HX_CSTRING("Error: Cannot rotate about a null Vec2"));
	}
	HX_STACK_LINE(1803)
	if (((angle != angle))){
		HX_STACK_LINE(1803)
		HX_STACK_DO_THROW(HX_CSTRING("Error: Cannot rotate by NaN radians"));
	}
	HX_STACK_LINE(1805)
		...
		HX_STACK_LINE(1809)
		{
			...
			HX_STACK_LINE(1809)
			{
				...
				HX_STACK_LINE(1809)
				{
					...
					HX_STACK_LINE(1809)
					if ((!(((  (((_g == x))) ? bool(_Function_5_1::Block(y,_this)) : bool(false) ))))){
						HX_STACK_LINE(1809)
						{
							HX_STACK_LINE(1809)
							_this->zpp_inner->x = x;
		...
		while((true)){
			...
			HX_STACK_LINE(1844)
			{
				...
				HX_STACK_LINE(1844)
				{
					...
					if (((material == null()))){
						HX_STACK_LINE(1844)
						HX_STACK_DO_THROW(HX_CSTRING("Error: Cannot assign null as Shape material"));
					}
					HX_STACK_LINE(1844)
		...
		while((true)){
			...
			HX_STACK_LINE(1868)
			{
				...
				HX_STACK_LINE(1868)
				{
					...
					if (((filter == null()))){
						HX_STACK_LINE(1868)
						HX_STACK_DO_THROW(HX_CSTRING("Error: Cannot assign null as Shape filter"));
					}
					HX_STACK_LINE(1868)
			...
			HX_STACK_LINE(1892)
			{
				...
				HX_STACK_LINE(1892)
				{
					...
					if (((fluidProperties == null()))){
						HX_STACK_LINE(1892)
						HX_STACK_DO_THROW(HX_CSTRING("Error: Cannot assign null as Shape fluidProperties, disable fluids by setting fluidEnabled to false"));
					}
					HX_STACK_LINE(1892)
...
::nape::geom::Vec2 Body_obj::get_localCOM( ){
	...
	if ((this->zpp_inner->world)){
		HX_STACK_LINE(1910)
		HX_STACK_DO_THROW(HX_CSTRING("Error: Space::world has no localCOM"));
	}
	HX_STACK_LINE(1912)
...
::nape::geom::Vec2 Body_obj::get_worldCOM( ){
	...
	if ((this->zpp_inner->world)){
		HX_STACK_LINE(1932)
		HX_STACK_DO_THROW(HX_CSTRING("Error: Space::world has no worldCOM"));
	}
	HX_STACK_LINE(1934)
...
bool Body_obj::contains( ::nape::geom::Vec2 point){
	...
	if (((point == null()))){
		HX_STACK_LINE(2512)
		HX_STACK_DO_THROW(HX_CSTRING("Error: Cannot check containment of null point"));
	}
	HX_STACK_LINE(2514)
