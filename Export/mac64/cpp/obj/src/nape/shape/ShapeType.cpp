...
{
HX_STACK_FRAME("nape.shape.ShapeType","new",0xb55a943a,"nape.shape.ShapeType.new","nape/shape/ShapeType.hx",183,0xe7bde238)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(183)
	if ((!(::zpp_nape::util::ZPP_Flags_obj::internal))){
		HX_STACK_LINE(183)
		HX_STACK_DO_THROW(HX_CSTRING("Error: Cannot instantiate ShapeType derp!"));
	}
}
;
	return null();
