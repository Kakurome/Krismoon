...
HX_STACK_THIS(this)
{
	...
	HX_STACK_LINE(224)
	HX_STACK_DO_THROW(HX_CSTRING("Error: Shape cannot be instantiated derp!"));
}
;
	return null();
}
...
::nape::geom::Vec2 Shape_obj::set_localCOM( ::nape::geom::Vec2 localCOM){
	...
	HX_STACK_LINE(306)
	{
		...
		if (((bool((bool((this->zpp_inner->body != null())) && bool((this->zpp_inner->body->space != null())))) && bool((this->zpp_inner->body->type == ::zpp_nape::util::ZPP_Flags_obj::id_BodyType_STATIC))))){
			HX_STACK_LINE(314)
			HX_STACK_DO_THROW(HX_CSTRING("Error: Cannot modify Shape belonging to a static Object once inside a Space"));
		}
		HX_STACK_LINE(315)
		if (((localCOM == null()))){
			HX_STACK_LINE(315)
			HX_STACK_DO_THROW(HX_CSTRING("Error: Shape::localCOM cannot be null"));
		}
		HX_STACK_LINE(317)
		{
			HX_STACK_LINE(317)
...
::nape::shape::Shape Shape_obj::translate( ::nape::geom::Vec2 translation){
	...
	if (((translation == null()))){
		HX_STACK_LINE(496)
		HX_STACK_DO_THROW(HX_CSTRING("Error: Cannot displace Shape by null Vec2"));
	}
	HX_STACK_LINE(498)
...
::nape::shape::Shape Shape_obj::scale( Float scalex,Float scaley){
	...
	if (((bool((scalex != scalex)) || bool((scaley != scaley))))){
		HX_STACK_LINE(531)
		HX_STACK_DO_THROW(HX_CSTRING("Error: Cannot scale Shape by NaN"));
	}
	HX_STACK_LINE(532)
	if (((bool((scalex == (int)0)) || bool((scaley == (int)0))))){
		HX_STACK_LINE(532)
		HX_STACK_DO_THROW(HX_CSTRING("Error: Cannot Scale shape by a factor of 0"));
	}
	HX_STACK_LINE(534)
	if (((this->zpp_inner->type == ::zpp_nape::util::ZPP_Flags_obj::id_ShapeType_CIRCLE))){
		HX_STACK_LINE(535)
		...
		if ((((d * d) < (::nape::Config_obj::epsilon * ::nape::Config_obj::epsilon)))){
			...
			HX_STACK_LINE(541)
			HX_STACK_DO_THROW(HX_CSTRING("Error: Cannot perform a non equal scaling on a Circle"));
		}
	}
	else{
		HX_STACK_LINE(545)
...
::nape::shape::Shape Shape_obj::rotate( Float angle){
	...
	if (((angle != angle))){
		HX_STACK_LINE(561)
		HX_STACK_DO_THROW(HX_CSTRING("Error: Cannot rotate Shape by NaN"));
	}
	HX_STACK_LINE(563)
...
::nape::shape::Shape Shape_obj::transform( ::nape::geom::Mat23 matrix){
	...
	if (((matrix == null()))){
		HX_STACK_LINE(588)
		HX_STACK_DO_THROW(HX_CSTRING("Error: Cannot transform Shape by null matrix"));
	}
	HX_STACK_LINE(589)
	if ((matrix->singular())){
		HX_STACK_LINE(589)
		HX_STACK_DO_THROW(HX_CSTRING("Error: Cannot transform Shape by a singular matrix"));
	}
	HX_STACK_LINE(591)
	if (((this->zpp_inner->type == ::zpp_nape::util::ZPP_Flags_obj::id_ShapeType_CIRCLE))){
		HX_STACK_LINE(592)
		if ((matrix->equiorthogonal())){
			...
			HX_STACK_LINE(597)
			HX_STACK_DO_THROW(HX_CSTRING("Error: Cannot transform Circle by a non equiorthogonal matrix"));
		}
	}
	else{
		HX_STACK_LINE(601)
...
bool Shape_obj::contains( ::nape::geom::Vec2 point){
	...
	if (((point == null()))){
		HX_STACK_LINE(623)
		HX_STACK_DO_THROW(HX_CSTRING("Cannot check null point for containment"));
	}
	HX_STACK_LINE(626)
	if (((((  (((this->zpp_inner->body != null()))) ? ::nape::phys::Body(this->zpp_inner->body->outer) : ::nape::phys::Body(null()) )) == null()))){
		HX_STACK_LINE(626)
		HX_STACK_DO_THROW(HX_CSTRING("Error: Shape is not well defined without a Body"));
	}
	HX_STACK_LINE(628)
