...
{
HX_STACK_FRAME("nape.callbacks.InteractionType","new",0xd712f318,"nape.callbacks.InteractionType.new","nape/callbacks/InteractionType.hx",183,0xf2de5b1a)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(183)
	if ((!(::zpp_nape::util::ZPP_Flags_obj::internal))){
		HX_STACK_LINE(183)
		HX_STACK_DO_THROW(HX_CSTRING("Error: Cannot instantiate InteractionType derp!"));
	}
}
;
	return null();
