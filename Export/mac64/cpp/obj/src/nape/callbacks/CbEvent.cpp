...
{
HX_STACK_FRAME("nape.callbacks.CbEvent","new",0x341515e7,"nape.callbacks.CbEvent.new","nape/callbacks/CbEvent.hx",183,0xd410352b)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(183)
	if ((!(::zpp_nape::util::ZPP_Flags_obj::internal))){
		HX_STACK_LINE(183)
		HX_STACK_DO_THROW(HX_CSTRING("Error: Cannot instantiate CbEvent derp!"));
	}
}
;
	return null();
