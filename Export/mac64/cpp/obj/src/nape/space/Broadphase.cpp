...
{
HX_STACK_FRAME("nape.space.Broadphase","new",0x8323b739,"nape.space.Broadphase.new","nape/space/Broadphase.hx",183,0xebaaca55)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(183)
	if ((!(::zpp_nape::util::ZPP_Flags_obj::internal))){
		HX_STACK_LINE(183)
		HX_STACK_DO_THROW(HX_CSTRING("Error: Cannot instantiate Broadphase derp!"));
	}
}
;
	return null();
