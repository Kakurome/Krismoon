...
::nape::geom::Vec2 AABB_obj::set_min( ::nape::geom::Vec2 min){
	...
	HX_STACK_LINE(284)
	{
		...
		if (((min == null()))){
			HX_STACK_LINE(295)
			HX_STACK_DO_THROW(HX_CSTRING("Error: Cannot assign null to AABB::min"));
		}
		HX_STACK_LINE(297)
		Float _g;		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(297)
		...
		struct _Function_2_1{
			inline static bool Block( hx::ObjectPtr< ::nape::geom::AABB_obj > __this){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/geom/AABB.hx",297,0x3e49ef52)
				{
					HX_STACK_LINE(297)
					Float _g2;		HX_STACK_VAR(_g2,"_g2");
					HX_STACK_LINE(297)
		...
		HX_STACK_LINE(297)
		if (((  ((!(((_g != _g1))))) ? bool(_Function_2_1::Block(this)) : bool(true) ))){
			HX_STACK_LINE(298)
			HX_STACK_DO_THROW(HX_CSTRING("Error: AABB::min components cannot be NaN"));
		}
		HX_STACK_LINE(300)
		{
			HX_STACK_LINE(301)
		...
		HX_STACK_LINE(309)
		{
			...
			HX_STACK_LINE(309)
			{
				...
				HX_STACK_LINE(309)
				if ((!(((  (((_g12 == x))) ? bool(_Function_4_1::Block(y,_this)) : bool(false) ))))){
					HX_STACK_LINE(309)
					{
						HX_STACK_LINE(309)
						_this->zpp_inner->x = x;
...
::nape::geom::Vec2 AABB_obj::set_max( ::nape::geom::Vec2 max){
	...
	HX_STACK_LINE(333)
	{
		...
		if (((max == null()))){
			HX_STACK_LINE(344)
			HX_STACK_DO_THROW(HX_CSTRING("Error: Cannot assign null to AABB::max"));
		}
		HX_STACK_LINE(346)
		Float _g;		HX_STACK_VAR(_g,"_g");
		HX_STACK_LINE(346)
		...
		struct _Function_2_1{
			inline static bool Block( hx::ObjectPtr< ::nape::geom::AABB_obj > __this){
				HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/geom/AABB.hx",346,0x3e49ef52)
				{
					HX_STACK_LINE(346)
					Float _g2;		HX_STACK_VAR(_g2,"_g2");
					HX_STACK_LINE(346)
		...
		if (((  ((!(((_g != _g1))))) ? bool(_Function_2_1::Block(this)) : bool(true) ))){
			HX_STACK_LINE(347)
			HX_STACK_DO_THROW(HX_CSTRING("Error: AABB::max components cannot be NaN"));
		}
		HX_STACK_LINE(353)
		{
			HX_STACK_LINE(354)
...
Float AABB_obj::set_x( Float x){
	...
	HX_STACK_LINE(375)
	{
		...
		if (((_g != x))){
			...
			if (((x != x))){
				HX_STACK_LINE(383)
				HX_STACK_DO_THROW(HX_CSTRING("Error: AABB::x cannot be NaN"));
			}
			HX_STACK_LINE(385)
...
Float AABB_obj::set_y( Float y){
	...
	HX_STACK_LINE(405)
	{
		...
		if (((_g != y))){
			...
			if (((y != y))){
				HX_STACK_LINE(413)
				HX_STACK_DO_THROW(HX_CSTRING("Error: AABB::y cannot be NaN"));
			}
			HX_STACK_LINE(415)
...
Float AABB_obj::set_width( Float width){
	...
	HX_STACK_LINE(435)
	{
		...
		if (((_g != width))){
			...
			if (((width != width))){
				HX_STACK_LINE(444)
				HX_STACK_DO_THROW(HX_CSTRING("Error: AABB::width cannot be NaN"));
			}
			HX_STACK_LINE(446)
			if (((width < (int)0))){
				HX_STACK_LINE(447)
				HX_STACK_DO_THROW(((HX_CSTRING("Error: AABB::width (") + width) + HX_CSTRING(") must be >= 0")));
			}
			HX_STACK_LINE(450)
			Float _g1;		HX_STACK_VAR(_g1,"_g1");
			HX_STACK_LINE(450)
...
Float AABB_obj::set_height( Float height){
	...
	HX_STACK_LINE(469)
	{
		...
		if (((_g != height))){
			...
			if (((height != height))){
				HX_STACK_LINE(478)
				HX_STACK_DO_THROW(HX_CSTRING("Error: AABB::height cannot be NaN"));
			}
			HX_STACK_LINE(480)
			if (((height < (int)0))){
				HX_STACK_LINE(481)
				HX_STACK_DO_THROW(((HX_CSTRING("Error: AABB::height (") + height) + HX_CSTRING(") must be >= 0")));
			}
			HX_STACK_LINE(484)
			Float _g1;		HX_STACK_VAR(_g1,"_g1");
			HX_STACK_LINE(484)
