...
Float Geom_obj::distanceBody( ::nape::phys::Body body1,::nape::phys::Body body2,::nape::geom::Vec2 out1,::nape::geom::Vec2 out2){
	...
	struct _Function_1_1{
		inline static bool Block( ::nape::phys::Body &body1){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/geom/Geom.hx",237,0xa217fc96)
			{
				HX_STACK_LINE(237)
	...
	HX_STACK_LINE(237)
	if (((  ((!(_Function_1_1::Block(body1)))) ? bool(_Function_1_2::Block(body2)) : bool(true) ))){
		HX_STACK_LINE(237)
		HX_STACK_DO_THROW(HX_CSTRING("Error: Bodies cannot be empty in calculating distances"));
	}
	HX_STACK_LINE(239)
	{
		HX_STACK_LINE(240)
...
Float Geom_obj::distance( ::nape::shape::Shape shape1,::nape::shape::Shape shape2,::nape::geom::Vec2 out1,::nape::geom::Vec2 out2){
	...
	if (((bool((((  (((shape1->zpp_inner->body != null()))) ? ::nape::phys::Body(shape1->zpp_inner->body->outer) : ::nape::phys::Body(null()) )) == null())) || bool((((  (((shape2->zpp_inner->body != null()))) ? ::nape::phys::Body(shape2->zpp_inner->body->outer) : ::nape::phys::Body(null()) )) == null()))))){
		HX_STACK_LINE(315)
		HX_STACK_DO_THROW(HX_CSTRING("Error: Shape must be part of a Body to calculate distances"));
	}
	HX_STACK_LINE(317)
...
bool Geom_obj::intersectsBody( ::nape::phys::Body body1,::nape::phys::Body body2){
	...
	struct _Function_1_1{
		inline static bool Block( ::nape::phys::Body &body1){
			HX_STACK_FRAME("*","closure",0x5bdab937,"*.closure","nape/geom/Geom.hx",372,0xa217fc96)
			{
				HX_STACK_LINE(372)
				::nape::shape::ShapeList _this = body1->zpp_inner->wrap_shapes;		HX_STACK_VAR(_this,"_this");
				HX_STACK_LINE(372)
	...
	if (((  ((!(_Function_1_1::Block(body1)))) ? bool(_Function_1_2::Block(body2)) : bool(true) ))){
		HX_STACK_LINE(372)
		HX_STACK_DO_THROW(HX_CSTRING("Error: Bodies must have shapes to test for intersection."));
	}
	HX_STACK_LINE(374)
	{
		HX_STACK_LINE(375)
...
bool Geom_obj::intersects( ::nape::shape::Shape shape1,::nape::shape::Shape shape2){
	...
	if (((bool((((  (((shape1->zpp_inner->body != null()))) ? ::nape::phys::Body(shape1->zpp_inner->body->outer) : ::nape::phys::Body(null()) )) == null())) || bool((((  (((shape2->zpp_inner->body != null()))) ? ::nape::phys::Body(shape2->zpp_inner->body->outer) : ::nape::phys::Body(null()) )) == null()))))){
		HX_STACK_LINE(437)
		HX_STACK_DO_THROW(HX_CSTRING("Error: Shape must be part of a Body to calculate intersection"));
	}
	HX_STACK_LINE(439)
	::zpp_nape::geom::ZPP_Geom_obj::validateShape(shape1->zpp_inner);
	HX_STACK_LINE(440)
...
bool Geom_obj::contains( ::nape::shape::Shape shape1,::nape::shape::Shape shape2){
	...
	if (((bool((((  (((shape1->zpp_inner->body != null()))) ? ::nape::phys::Body(shape1->zpp_inner->body->outer) : ::nape::phys::Body(null()) )) == null())) || bool((((  (((shape2->zpp_inner->body != null()))) ? ::nape::phys::Body(shape2->zpp_inner->body->outer) : ::nape::phys::Body(null()) )) == null()))))){
		HX_STACK_LINE(458)
		HX_STACK_DO_THROW(HX_CSTRING("Error: Shape must be part of a Body to calculate containment"));
	}
	HX_STACK_LINE(460)
	::zpp_nape::geom::ZPP_Geom_obj::validateShape(shape1->zpp_inner);
	HX_STACK_LINE(461)
